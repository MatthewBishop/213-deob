public class NetFileRequest extends DualNode {
    ...
    static int method1877(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 3100) {
            ...
            FloorDecoration.performPlayerAnimation(MusicPatchNode.localPlayer,
            ...
            if (var0 == 3104) {
                ...
                PacketBufferNode var12 = class330.getPacketBufferNode(ClientPacket.OPLOC4,
                ...
                if (var0 == 3105) {
                    ...
                    if (var0 == 3107) {
                        ...
                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                - 1] = class20.clientPreferences.getRoofsHidden() ? 1 : 0;
                        return 1;
                    } else if (var0 == 3112) {
                        class20.clientPreferences.setRoofsHidden(
                                Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1);
                        return 1;
                    } else if (var0 == 3113) {
                        var3 = Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize];
                        ...
                        var7 = Interpreter.Interpreter_stringStack[SecureRandomCallable.Interpreter_stringStackSize];
                        String var5 = Interpreter.Interpreter_stringStack[SecureRandomCallable.Interpreter_stringStackSize
                                + 1];
                        if (var7.length() > 500) {
                            return 1;
                            ...
                            PacketBufferNode var6 = class330.getPacketBufferNode(ClientPacket.OPOBJ5,
                                    Client.packetWriter.isaacCipher);
                            var6.packetBuffer.writeShort(1 + DynamicObject.stringCp1252NullTerminatedByteSize(var7)
                                    + DynamicObject.stringCp1252NullTerminatedByteSize(var5));
                        ...
                        Client.field463 = 3;
                        Client.field526 = var2 ? SoundSystem.scriptDotWidget.id * 1713081171 * 346484955
                                : class1.scriptActiveWidget.id * 1713081171 * 346484955;
                        return 1;
                    } else {
                        boolean var15;
                        if (var0 == 3141) {
                            ...
                            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                    - 1] = class20.clientPreferences.getIsUsernameHidden() ? 1 : 0;
                            return 1;
                        } else if (var0 == 3143) {
                            var15 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
                            ...
                            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                    - 1] = class20.clientPreferences.getTitleMusicDisabled() ? 0 : 1;
                            return 1;
                        } else if (var0 == 3148) {
                            return 1;
                        } else if (var0 == 3149) {
                            ...
                            ApproximateRouteStrategy.method359(
                                    Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                            return 1;
                        } else if (var0 == 3182) {
                            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class103
                                    .method636();
                            return 1;
                        } else if (var0 == 3189) {
                            var8 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
    ...
    static int method1878(int var0, Script var1, boolean var2) {
        if (var0 == 6809) {
            ...
            Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize - 1] = var4 != null
                    ? var4.name
                    : "";
            return 1;
        } else {
    ...
    static final void method1876(Actor var0) {
                    ...
                    if (var0.movementFrame >= var1.frameIds.length) {
                        if (var1.frameCount > 0) {
                            ...
                            if (var0.movementFrame < 0 || var0.movementFrame >= var1.frameIds.length
                                    || var1.field1823 && var0.field975 >= var1.iterations) {
        ...
        if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
            ...
            if (var8.precedenceAnimating == 1 && var0.field1006 > 0 && var0.spotAnimation <= Client.cycle
                    && var0.exactMoveArrive1Cycle < Client.cycle) {
