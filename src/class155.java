    ...
    static final void drawMinimap(Widget var0, int var1, int var2, int var3) {
        ...
        if (var4 != null) {
            ...
            if (Client.minimapState != 2 && Client.minimapState != 5) {
                ...
                UrlRequester.sceneMinimapSprite.drawRotatedMaskedCenteredAround(var1, var2, var4.width, var4.height,
                        var6, var7, var5, 256, var4.xStarts, var4.xWidths);
                ...
                for (var10 = 0; var10 < var8; ++var10) {
                    ...
                    if (var16 != null && var16.isVisible() && !var16.isHidden && var16 != MusicPatchNode.localPlayer) {
                        ...
                        } else if (MusicPatchNode.localPlayer.team != 0 && var16.team != 0
                                && var16.team == MusicPatchNode.localPlayer.team) {
                ...
                if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
                    ...
                    if (Client.hintArrowType == 2) {
                        var10 = Client.hintArrowX * 4 - WorldMapData_0.baseX * 4 + 2
                                - MusicPatchNode.localPlayer.x / 32;
