...
public class class18 {
    ...
    static String method74() {
        return class20.clientPreferences.getIsUsernameHidden() ? WorldMapDecorationType.method1841(Login.Login_username)
            ...
            if (var0 == 3910) {
                ...
                if (var0 == 3914) {
                    ...
                    if (class375.grandExchangeEvents != null) {
                        class375.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_nameComparator,
                                var13);
                    }
                    ...
                    var13 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
                    if (class375.grandExchangeEvents != null) {
                        class375.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_priceComparator,
                                var13);
                    }
                    ...
                    var13 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
                    if (class375.grandExchangeEvents != null) {
                        class375.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_quantityComparator,
                                var13);
                    }
                    ...
                    Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                            - 1] = class375.grandExchangeEvents == null ? 0
                                    : class375.grandExchangeEvents.events.size();
                    return 1;
                } else {
                    ...
                    if (var0 == 3920) {
                        ...
                        Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
                                - 1] = var11.getOfferName();
                        return 1;
                    } else if (var0 == 3922) {
                        var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                        var11 = (GrandExchangeEvent) class375.grandExchangeEvents.events.get(var3);
                        Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
                                - 1] = var11.getPreviousOfferName();
                        return 1;
                    } else if (var0 == 3923) {
                        var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                        var11 = (GrandExchangeEvent) class375.grandExchangeEvents.events.get(var3);
    ...
    static final void drawEntities(int var0, int var1, int var2, int var3) {
        ...
        if (MusicPatchNode.localPlayer.x >> 7 == Client.destinationX
                && MusicPatchNode.localPlayer.y >> 7 == Client.destinationY) {
        ...
        if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0
                && (class33.oculusOrbFocalPointX >> 7 != MusicPatchNode.localPlayer.x >> 7
                        || class144.oculusOrbFocalPointY >> 7 != MusicPatchNode.localPlayer.y >> 7)) {
            ...
            PacketBufferNode var19 = class330.getPacketBufferNode(ClientPacket.field2545,
        ...
        if (!Client.isCameraLocked) {
            ...
            if (class20.clientPreferences.getRoofsHidden()) {
                ...
                if (var12 - class174.cameraY < 800
                        && (Tiles.Tiles_renderFlags[GameEngine.Client_plane][class36.cameraX >> 7][class297.cameraZ >> 7]
                                & 4) != 0) {
                    var11 = GameEngine.Client_plane;
                } else {
                    var11 = 3;
        ...
        for (var16 = 0; var16 < 5; ++var16) {
            if (Client.field620[var16]) {
                var17 = (int) (Math.random() * (double) (Client.field621[var16] * 2 + 1)
                        - (double) Client.field621[var16]
                        + Math.sin((double) Client.cameraShakeCycle[var16] * ((double) Client.field499[var16] / 100.0D))
                                * (double) Client.field643[var16]);
                if (var16 == 0) {
        ...
        class31.scene.draw(class36.cameraX, class174.cameraY, class297.cameraZ, WorldMapSectionType.cameraPitch,
                class125.cameraYaw, var10);
        ...
        for (var24 = 0; var24 < Client.overheadTextCount; ++var24) {
            ...
            while (var29) {
                ...
                for (int var30 = 0; var30 < var24; ++var30) {
                    if (var26 + 2 > Client.overheadTextYs[var30] - Client.overheadTextAscents[var30]
                            && var26 - var28 < Client.overheadTextYs[var30] + 2
                            && var36 - var27 < Client.overheadTextXOffsets[var30] + Client.overheadTextXs[var30]
                            && var36 + var27 > Client.overheadTextXs[var30] - Client.overheadTextXOffsets[var30]
                            && Client.overheadTextYs[var30] - Client.overheadTextAscents[var30] < var26) {
            ...
            if (Client.chatEffects == 0) {
                ...
                if (Client.overheadTextEffects[var24] == 0) {
                    class137.fontBold12.drawCentered(var37, var0 + Client.viewportTempX, Client.viewportTempY + var1,
                            var31, 0);
                }

                if (Client.overheadTextEffects[var24] == 1) {
                    class137.fontBold12.drawCenteredWave(var37, var0 + Client.viewportTempX,
                            Client.viewportTempY + var1, var31, 0, Client.viewportDrawCount);
                }

                if (Client.overheadTextEffects[var24] == 2) {
                    class137.fontBold12.drawCenteredWave2(var37, var0 + Client.viewportTempX,
                            Client.viewportTempY + var1, var31, 0, Client.viewportDrawCount);
                }

                if (Client.overheadTextEffects[var24] == 3) {
                    class137.fontBold12.drawCenteredShake(var37, var0 + Client.viewportTempX,
                            Client.viewportTempY + var1, var31, 0, Client.viewportDrawCount,
                ...
                if (Client.overheadTextEffects[var24] == 4) {
                    var32 = (150 - Client.overheadTextCyclesRemaining[var24])
                            * (class137.fontBold12.stringWidth(var37) + 100) / 150;
                    Rasterizer2D.Rasterizer2D_expandClip(var0 + Client.viewportTempX - 50, var1,
                            var0 + Client.viewportTempX + 50, var3 + var1);
                    class137.fontBold12.draw(var37, var0 + Client.viewportTempX + 50 - var32,
                            Client.viewportTempY + var1, var31, 0);
                    Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1);
                }
                ...
                if (Client.overheadTextEffects[var24] == 5) {
                    ...
                    Rasterizer2D.Rasterizer2D_expandClip(var0,
                            Client.viewportTempY + var1 - class137.fontBold12.ascent - 1, var0 + var2,
                            Client.viewportTempY + var1 + 5);
                    class137.fontBold12.drawCentered(var37, var0 + Client.viewportTempX,
                            var33 + Client.viewportTempY + var1, var31, 0);
                    Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1);
                }
            } else {
                class137.fontBold12.drawCentered(var37, var0 + Client.viewportTempX, Client.viewportTempY + var1,
