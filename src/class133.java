...
public class class133 extends DualNode {
    ...
    static void queueSoundEffect(int var0, int var1, int var2) {
        if (class20.clientPreferences.getCurrentSoundEffectsVolume() != 0 && var1 != 0
    ...
    static final void method777(int var0, int var1, int var2) {
        if (class36.cameraX < var0) {
            class36.cameraX = (var0 - class36.cameraX) * class138.field1314 / 1000 + class36.cameraX
                    + KeyHandler.field81;
            if (class36.cameraX > var0) {
        ...
        if (class174.cameraY < var1) {
            class174.cameraY = (var1 - class174.cameraY) * class138.field1314 / 1000 + class174.cameraY
                    + KeyHandler.field81;
            if (class174.cameraY > var1) {
        ...
        if (class297.cameraZ < var2) {
            class297.cameraZ = (var2 - class297.cameraZ) * class138.field1314 / 1000 + class297.cameraZ
                    + KeyHandler.field81;
            if (class297.cameraZ > var2) {
