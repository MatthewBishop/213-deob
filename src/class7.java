...
public class class7 {
    ...
    static final void changeGameOptions(int var0) {
        ...
        if (var1 != 0) {
            ...
            if (var1 == 18) {
                Client.playerAttackOption = (AttackOption) StructComposition.findEnumerated(UserComparator4.method685(),
                        var2);
            ...
            if (var1 == 22) {
                Client.npcAttackOption = (AttackOption) StructComposition.findEnumerated(UserComparator4.method685(),
                        var2);
