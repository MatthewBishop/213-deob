...
public class class335 {
    ...
    static final void method1851(Widget var0) {
        ...
        if (var0.buttonType == 2 && !Client.isSpellSelected) {
            ...
            if (var1 != null) {
                class138.method796(var1, class383.colorStartTag(65280) + var0.field3004, 25, 0, -1, var0.id,
                        var0.itemId);
            }
        }
        ...
        if (var0.isIf3) {
            if (Client.isSpellSelected) {
                if (ScriptEvent.method492(KeyHandler.getWidgetFlags(var0))
                        && (SecureRandomFuture.selectedSpellFlags & 32) == 32) {
                    class138.method796(Client.field530, Client.field522 + " " + "->" + " " + var0.dataText, 58, 0,
                            var0.childIndex, var0.id, var0.itemId);
                }
            } else {
                for (int var6 = 9; var6 >= 5; --var6) {
                    ...
                    if (!var11 && var0.onOp == null) {
                        var7 = null;
                    } else if (var0.actions != null && var0.actions.length > var6 && var0.actions[var6] != null
                            && var0.actions[var6].trim().length() != 0) {
                ...
                for (var2 = 4; var2 >= 0; --var2) {
                    ...
                    if (var8 != null) {
                        SceneTilePaint.insertMenuItem(var8, var0.dataText, 57, var2 + 1, var0.childIndex, var0.id,
