public class class315 {
    ...
    public static final short[][] field2863 = new short[][] {
    ...
    public static final short[][] field2866 = new short[][] {
    ...
    static void getLoginError(int var0) {
        ...
        if (var0 == -3) {
            ...
            Login.field752 = 2;
            class205.setLoginResponseString("Either your account is still logged in, or the last",
            ...
            if (var0 == 7) {
                ...
                class205.setLoginResponseString("We suspect someone knows your password.",
                        "Press 'change your password' on front page.", "");
            } else if (var0 == 12) {
                class205.setLoginResponseString("You need a members account to login to this world.",
                ...
                class205.setLoginResponseString("Too many login attempts.",
                        "You can use the Jagex Launcher to continue playing.",
                        "Press the button below to download it now.");
                class129.method763(33);
            } else if (var0 == 17) {
                class205.setLoginResponseString("To access this free world, log into a",
                        "members world and move your character", "to a non-members area.");
            } else if (var0 == 18) {
                class14.method55(1);
            } else if (var0 == 19) {
                class205.setLoginResponseString("This world is running a closed Beta.", "Sorry invited players only.",
                ...
                class205.setLoginResponseString("Unexpected loginserver response.",
                        "Please try using a different world.", "");
            } else if (var0 == 26) {
                class205.setLoginResponseString("This computers address has been blocked",
                        "as it was used to break our rules.", "");
            } else if (var0 == 27) {
                class205.setLoginResponseString("", "Service unavailable.", "");
            } else if (var0 == 31) {
                class205.setLoginResponseString("Your account must have a displayname set",
                        "in order to play the game.  Please set it", "via the website, or the main game.");
            } else if (var0 == 32) {
                class14.method55(2);
            } else if (var0 == 37) {
                class205.setLoginResponseString("Your account is currently inaccessible.",
                        "Please try again in a few minutes.", "");
            } else if (var0 == 38) {
                class205.setLoginResponseString("You need to vote to play!", "Visit runescape.com and vote,",
                ...
                if (var0 == 61) {
                    ...
                    if (var0 == 71) {
                        class138.updateGameState(10);
                        class129.method763(7);
                        class205.setLoginResponseString("There was a problem updating your DOB.",
                                "Please try again later. If the problem ", "persists, please contact Jagex Support.");
                    } else if (var0 == 73) {
                        class138.updateGameState(10);
                        class129.method763(6);
                        class205.setLoginResponseString("Your date of birth information is waiting",
                                "to be reviewed by our staff.", "It will be processed shortly.");
                    } else if (var0 == 72) {
                        class138.updateGameState(10);
                        class129.method763(32);
                    } else {
                        class205.setLoginResponseString("Unexpected server response",
                                "Please try using a different world.", "");
                    }
                }
            }
