public class class327 {
    ...
    static int method1843(int var0, Script var1, boolean var2) {
        if (var0 == 6200) {
            ...
            Client.field625 = (short) VertexNormal
                    .method1346(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize]);
            if (Client.field625 <= 0) {
                Client.field625 = 256;
            }

            Client.field626 = (short) VertexNormal
                    .method1346(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
            ...
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = SoundSystem
                    .method246(Client.field625);
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = SoundSystem
                    .method246(Client.field626);
            return 1;
        } else if (var0 == 6220) {
