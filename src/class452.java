public class class452 extends class455 {
    ...
    public class452(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
            int var10) {
        super(var9, var10);
        this.field3884 = var3;
        this.field3879 = var6;
        if ((var5 - var8) * (var7 - var1) == (var4 - var7) * (var8 - var2)) {
            ...
            this.field3882 = Math.sqrt(
                    Math.pow(this.field3883 - (double) var1, 2.0D) + Math.pow(this.field3881 - (double) var2, 2.0D));
            ...
            boolean var25 = this.field3885 <= var23 && var23 <= this.field3878
                    || this.field3878 <= var23 && var23 <= this.field3885;
            if (!var25) {
