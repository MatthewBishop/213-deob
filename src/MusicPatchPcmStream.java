public class MusicPatchPcmStream extends PcmStream {
        ...
        if ((this.superStream.field2746[var1.field2801] & 4) != 0 && var1.field2798 < 0) {
            ...
            while (true) {
                ...
                if (this.superStream.field2749[var1.field2801] == 0) {
                    var1.stream = RawPcmStream.method294(var1.rawSound, var10.method270(), var10.method262(),
                            var10.method285());
                } else {
    ...
    void method1668(MusicPatchNode var1, int var2) {
        if ((this.superStream.field2746[var1.field2801] & 4) != 0 && var1.field2798 < 0) {
            ...
            if (var4 <= var2) {
                if (this.superStream.field2749[var1.field2801] == 0) {
                    var1.stream = RawPcmStream.method294(var1.rawSound, var1.stream.method270(),
                            var1.stream.method262(), var1.stream.method285());
                } else {
                    var1.stream = RawPcmStream.method294(var1.rawSound, var1.stream.method270(), 0,
                            var1.stream.method285());
                    this.superStream.method1639(var1, var1.patch.field2771[var1.field2788] < 0);
                }
    ...
    static int method1665(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 4200) {
            ...
            Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
                    - 1] = HealthBarUpdate.ItemDefinition_get(var3).name;
            return 1;
        } else {
            int var4;
            ...
            if (var0 == 4201) {
                ...
                var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = HealthBarUpdate
                        .ItemDefinition_get(var3).price;
                return 1;
            } else if (var0 == 4204) {
                var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                        - 1] = HealthBarUpdate.ItemDefinition_get(var3).isStackable == 1 ? 1 : 0;
                return 1;
            } else {
                ...
                if (var0 == 4205) {
                    ...
                    var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                    Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                            - 1] = HealthBarUpdate.ItemDefinition_get(var3).isMembersOnly ? 1 : 0;
                    return 1;
                } else if (var0 == 4208) {
                    var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                    var6 = HealthBarUpdate.ItemDefinition_get(var3);
                    ...
                    if (class399.foundItemIds != null && FontName.foundItemIndex < class264.foundItemIdCount) {
                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                - 1] = class399.foundItemIds[++FontName.foundItemIndex - 1] & '\uffff';
                    } else {
