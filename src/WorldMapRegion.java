...
public class WorldMapRegion {
    ...
    void getIconsForTiles(int var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
        for (int var6 = var1; var6 < var3 + var1; ++var6) {
            label67: for (int var7 = var2; var7 < var2 + var4; ++var7) {
    ...
    void addAllToIconList(List var1) {
        ...
        while (var2.hasNext()) {
            ...
            if (class354.WorldMapElement_get(var3.element).field1489 && var3.coord2.x >> 6 == this.regionX
                    && var3.coord2.y >> 6 == this.regionY) {
                WorldMapIcon_0 var4 = new WorldMapIcon_0(var3.coord2, var3.coord2, var3.element,
                        this.method1457(var3.element));
        ...
        if (this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) {
            if (VarpDefinition.method982(this.regionX, this.regionY, var1) == null) {
                ...
                if (var6) {
                    ...
                    WorldMapRegion_cachedSprites.put(var11, BuddyRankComparator.method710(var12, var13, var14),
                            var11.pixels.length * 4);
                    this.method1441();
                }
            }
        }
    ...
    void drawTileGround(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, WorldMapSprite var5) {
        ...
        if (var7 != -1) {
            ...
            FloorOverlayDefinition var12 = (FloorOverlayDefinition) FloorOverlayDefinition.FloorOverlayDefinition_cached
                    .get((long) var7);
            ...
            if (var11 == null) {
                ...
                if (var11.secondaryRgb >= 0) {
                    ...
                    int var19 = class97.method617(
                            Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var11.texture), 96);
        ...
        if (var7 > -1 && var3.field2390[0][var1][var2] == 0) {
            ...
            if (var7 == -1) {
                ...
                var4.method1557(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), var9, var8,
                        this.pixelsPerTile, this.pixelsPerTile, var3.field2390[0][var1][var2],
                        var3.field2396[0][var1][var2]);
            }
        }
    }
    ...
    void method1467(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4) {
        for (int var5 = 1; var5 < var3.planes; ++var5) {
            ...
            if (var6 > -1) {
                ...
                FloorOverlayDefinition var10 = (FloorOverlayDefinition) FloorOverlayDefinition.FloorOverlayDefinition_cached
                        .get((long) var6);
                ...
                if (var9 == null) {
                    ...
                    if (var9.secondaryRgb >= 0) {
                        ...
                        int var17 = class97.method617(
                                Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var9.texture), 96);
                ...
                if (var3.field2390[var5][var1][var2] == 0) {
                    ...
                    var4.method1557(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 0, var7,
                            this.pixelsPerTile, this.pixelsPerTile, var3.field2390[var5][var1][var2],
                            var3.field2396[var5][var1][var2]);
                }
            }
        }
                ...
                for (int var8 = 0; var8 < var7.length; ++var8) {
                    ...
                    if (var12.mapSceneId != -1) {
                        if (var12.mapSceneId != 46 && var12.mapSceneId != 52) {
                            var4[var12.mapSceneId].method2596(this.pixelsPerTile * var1,
        ...
        for (int var4 = 0; var4 < var3.planes; ++var4) {
            ...
            if (var5 != null && var5.length != 0) {
                ...
                for (int var7 = 0; var7 < var6.length; ++var7) {
                    ...
                    boolean var9 = var10 >= WorldMapDecorationType.field3047.id
                            && var10 <= WorldMapDecorationType.field3050.id
                            || var10 == WorldMapDecorationType.field3048.id;
                    if (var9) {
                        ...
                        if (var8.decoration == WorldMapDecorationType.field3050.id) {
                            if (var8.rotation == 0) {
                                Rasterizer2D.Rasterizer2D_drawHorizontalLine(this.pixelsPerTile * var1,
                                        this.pixelsPerTile * (63 - var2), 1, var12);
                            }
                            ...
                            if (var8.rotation == 2) {
                                Rasterizer2D.Rasterizer2D_drawHorizontalLine(
                                        ...
                                        this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, 1, var12);
                            }
                        ...
                        if (var8.decoration == WorldMapDecorationType.field3048.id) {
                            ...
                            if (var13 == 0) {
                                for (var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                                    Rasterizer2D.Rasterizer2D_drawHorizontalLine(var14 + this.pixelsPerTile * var1,
                                            (64 - var2) * this.pixelsPerTile - 1 - var14, 1, var12);
                                }
                            } else {
                                for (var14 = 0; var14 < this.pixelsPerTile; ++var14) {
                                    Rasterizer2D.Rasterizer2D_drawHorizontalLine(var14 + this.pixelsPerTile * var1,
                                            var14 + this.pixelsPerTile * (63 - var2), 1, var12);
                                }
                            }
                        }
                    }
        ...
        if (var6 != null) {
            if (var6.size.method1394(var5)) {
                ...
                var7.drawLines(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height,
                        -16777216 | var2.field1484, 0, 1, 0, var7.ascent / 2);
            }
        }
    }
