public class UserComparator6 extends AbstractUserComparator {
    ...
    static int method714(int var0, Script var1, boolean var2) {
        if (var0 == 5000) {
            ...
            FloorUnderlayDefinition.privateChatMode = class399
                    .method2129(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
            ...
            PacketBufferNode var11 = class330.getPacketBufferNode(ClientPacket.field2502,
                    ...
                    if (var0 == 5004) {
                        ...
                        if (FloorUnderlayDefinition.privateChatMode == null) {
                            ...
                            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                    - 1] = FloorUnderlayDefinition.privateChatMode.id;
                        }
                        ...
                        if (var0 == 5008) {
                            ...
                            var3 = Interpreter.Interpreter_stringStack[SecureRandomCallable.Interpreter_stringStackSize];
                            String var13 = Interpreter.Interpreter_stringStack[SecureRandomCallable.Interpreter_stringStackSize
                                    + 1];
                            var12 = class330.getPacketBufferNode(ClientPacket.field2522,
                                    Client.packetWriter.isaacCipher);
                            ...
                            if (var0 == 5016) {
                                ...
                                var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = World
                                        .Messages_getHistorySize(var7);
                                return 1;
                            } else if (var0 == 5018) {
                                var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                        - 1] = FaceNormal.Messages_getLastChatID(var7);
                                return 1;
                            } else if (var0 == 5019) {
                                var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                        - 1] = BuddyRankComparator.method707(var7);
                                return 1;
                            } else if (var0 == 5020) {
                                var3 = Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize];
                                ...
                                Client.field586 = Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize]
                                        .toLowerCase().trim();
                                return 1;
                            } else if (var0 == 5022) {
                                Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
