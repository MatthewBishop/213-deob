public final class Player extends Actor {
            ...
            if (var3 == null) {
                ...
                if (!this.isUnanimated && this.attachedModel != null) {
                    ...
                    if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
                        ...
                        var5.offsetBy(this.field899 - super.x, this.baseTileHeight - this.tileHeight,
                                this.field903 - super.y);
                        ...
                        var5.offsetBy(super.x - this.field899, this.tileHeight - this.baseTileHeight,
                                super.y - this.field903);
                    }
                }
    ...
    void checkIsFriend() {
        this.isFriendTriBool = World.friendSystem.isFriendAndHasWorld(this.username) ? TriBool.TriBool_true
    ...
    void updateIsInFriendsChat() {
        this.isInFriendsChat = UserComparator5.friendsChat != null
                && UserComparator5.friendsChat.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false;
    }

    void updateIsInClanChat() {
        for (int var1 = 0; var1 < 4; ++var1) {
            if (Client.currentClanSettings[var1] != null
                    && Client.currentClanSettings[var1].method851(this.username.getName()) != -1 && var1 != 2) {
    ...
    int transformedSize() {
        return this.appearance != null && this.appearance.npcTransformId != -1
                ? AbstractArchive.getNpcDefinition(this.appearance.npcTransformId).size
                : 1;
    }
