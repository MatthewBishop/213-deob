...
public class ReflectionCheck extends Node {
    ...
    static final void updateActorSequence(Actor var0, int var1) {
        ...
        if (var0.spotAnimation >= Client.cycle) {
            ...
            if (var0.exactMoveArrive1Cycle >= Client.cycle) {
                boolean var15 = var0.exactMoveArrive1Cycle == Client.cycle || var0.sequence == -1
                    ...
                    label398: {
                        ...
                        if (var4 - var2 <= 256 && var4 - var2 >= -256 && var5 - var3 <= 256 && var5 - var3 >= -256) {
                            ...
                            if (var9 >= 8) {
                                ...
                                } else if (var0.walkRightSequence == var0.movementSequence
                                ...
                                } else if (var0.walkBackSequence == var0.movementSequence
    ...
    static final void updateRootInterface(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
        if (SoundSystem.loadInterface(var0)) {
            ViewportMouse.updateInterface(VerticalAlignment.Widget_interfaceComponents[var0], -1, var1, var2, var3,
                    var4, var5, var6);
        }
    }
}
