...
public class WorldMap {
    ...
    public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
        if (this.cacheLoader.isLoaded()) {
            ...
            if (var3) {
                ...
                List var10 = this.worldMapManager.method1478(this.centerTileX - var8 / 2 - 1,
    ...
    public void method2331(int var1, int var2, boolean var3, boolean var4) {
        ...
        if (!this.hasTarget() && (var4 || var3) && !InvDefinition.method978()) {
            ...
            if (this.field3933 != -1) {
                ...
                this.setWorldMapPosition(this.field3933 - (int) ((float) var7 / this.zoomTarget),
                        (int) ((float) var8 / this.zoomTarget) + this.field3942, false);
            }
        } else {
            this.method2334();
        }
        ...
        if (this.currentMapArea != null) {
            ...
            if (this.mouseCoord != null && var3) {
                ...
                if (var10 && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
                    ...
                    PacketBufferNode var14 = class330.getPacketBufferNode(ClientPacket.field2545,
                    ...
                    if (var11) {
                        PacketBufferNode var15 = class330.getPacketBufferNode(ClientPacket.field2510,
                                Client.packetWriter.isaacCipher);
        ...
        if (var7 < 100) {
            ...
            if (!this.elementsDisabled) {
                ...
                this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
                        var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4,
                        this.field3944, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
            }
    ...
    void method2339(int var1, int var2, int var3, int var4, int var5, int var6) {
        if (class132.field1277 != null) {
            ...
            if (this.method2366(var8, var9, var13, var14, var3, var4)) {
                ...
                class132.field1277.method1938(this.minCachedTileX, this.minCachedTileY, this.sprite,
    ...
    public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
        if (this.cacheLoader.isLoaded()) {
            ...
            List var9 = this.worldMapManager.method1478(this.centerTileX - var7 / 2 - 1,
                ...
                do {
                    ...
                    for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) {
                        if (var12.menuActions[var14] != null) {
                            MenuAction.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName,
