public class class252 implements WorldMapSection {
    ...
    public boolean containsCoord(int var1, int var2, int var3) {
        if (var1 >= this.field2350 && var1 < this.field2353 + this.field2350) {
            return var2 >= (this.field2346 << 6) + (this.field2349 << 3)
                    && var2 <= (this.field2346 << 6) + (this.field2349 << 3) + 7
                    && var3 >= (this.field2347 << 6) + (this.field2351 << 3)
                    && var3 <= (this.field2347 << 6) + (this.field2351 << 3) + 7;
        } else {
            return false;
        }
    }
    ...
    public boolean containsPosition(int var1, int var2) {
        return var1 >= (this.field2345 << 6) + (this.field2352 << 3)
                && var1 <= (this.field2345 << 6) + (this.field2352 << 3) + 7
                && var2 >= (this.field2354 << 6) + (this.field2348 << 3)
                && var2 <= (this.field2354 << 6) + (this.field2348 << 3) + 7;
    }
    ...
    public int[] getBorderTileLengths(int var1, int var2, int var3) {
        if (!this.containsCoord(var1, var2, var3)) {
            ...
            int[] var4 = new int[] {
                    var2 + (this.field2345 * 64 - this.field2346 * 64) + (this.field2352 * 8 - this.field2349 * 8),
                    var3 + (this.field2354 * 64 - this.field2347 * 64) + (this.field2348 * 8 - this.field2351 * 8) };
            return var4;
        }
    }
    ...
    public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
        ...
        if (var20 == null) {
            ...
            var20.method1343(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d,
                    var20.height / 2 + var18 + var9.offsetY2d, var19 + var9.offsetY2d);
            if (var9.notedId != -1) {
                var21.drawTransBgAt(0, 0);
            }
