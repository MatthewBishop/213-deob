public class ObjectComposition extends DualNode {
    ...
    static int method1094(int var0, Script var1, boolean var2) {
        if (var0 == 3200) {
            ...
            class133.queueSoundEffect(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
            ...
            CollisionMap.playJingle(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
                    Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
            return 1;
        } else {
            int var6;
                ...
                if (var0 != 3214 && var0 != 3215 && var0 != 3210 && var0 != 3182 && var0 != 3204 && var0 != 3206
                    ...
                    if (var0 == 3211) {
                        ...
                        if (var0 == 3216) {
                            ...
                            var4 = 0;
                            class86 var13 = (class86) StructComposition.findEnumerated(ArchiveDiskAction.method1858(),
                                    var3);
                            if (var13 != null) {
