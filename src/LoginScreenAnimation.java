public class LoginScreenAnimation {
    ...
    final void method547(int var1) {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            var6 = this.field1022[var2 + var3]
                    - this.field1023[var2 + this.field1026 & this.field1023.length - 1] * var1 / 6;
            if (var6 < 0) {
                var6 = 0;
            }
        ...
        for (var7 = 256 - var1; var7 < 256; ++var7) {
            this.field1014[var7] = (int) (Math.sin((double) this.field1015 / 14.0D) * 16.0D
        ...
        for (int var3 = 1; var3 < 255; ++var3) {
            ...
            for (int var9 = var6; var9 < var7; ++var9) {
                ...
                if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart
                    ...
                    RouteStrategy.rasterProvider.pixels[var8++] = -16777216
                            | (var12 * (var10 & '\uff00') + var13 * (var14 & '\uff00') & 16711680)
                                    + ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) >> 8;
                } else {
                    ++var8;
                }
            }
        ...
        for (var2 = 0; var2 < 20; ++var2) {
            for (var3 = 1; var3 < 255; ++var3) {
                for (var4 = 1; var4 < 127; ++var4) {
                    var5 = var4 + (var3 << 7);
                    this.field1019[var5] = (this.field1023[var5 - 128] + this.field1023[var5 + 1]
