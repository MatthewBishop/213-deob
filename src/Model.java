...
public class Model extends Renderable {
    ...
    void method1310(Model var1) {
        ...
        if (this.faceRenderPriorities == null
                && (var1.faceRenderPriorities != null || this.field2152 != var1.field2152)) {
    ...
    void method1325(class133 var1, int var2) {
        ...
        for (int var4 = 0; var4 < var3.count; ++var4) {
            ...
            if (var5 == 5 && var1.field1282 != null && var1.field1282[var4] != null && var1.field1282[var4][0] != null
                ...
                if (this.faceColors3[var7] != -2) {
                    ...
                    if (!var1 || var11 != -5000 && var12 != -5000 && var13 != -5000) {
                        ...
                        if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9])
                            ...
                            if (var11 >= 0 && var12 >= 0 && var13 >= 0 && var11 <= var14 && var12 <= var14
                                    && var13 <= var14) {
    ...
    final void drawFace(int var1) {
        if (field2169[var1]) {
            ...
            this.method1332(var1, modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
                    modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], field2172[var2],
                    field2172[var3], field2172[var4], this.faceColors1[var1], this.faceColors2[var1],
    ...
    final void method1332(int var1, int var2, int var3, int var4, int var5, int var6, int var7, float var8, float var9,
        ...
        if (this.faceTextures != null && this.faceTextures[var1] != -1) {
            ...
            if (this.faceColors3[var1] == -1) {
                DevicePcmPlayerProvider.method89(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var11,
                        var11, field2161[var20], field2161[var21], field2161[var22], field2175[var20], field2175[var21],
                        field2175[var22], field2200[var20], field2200[var21], field2200[var22],
                        this.faceTextures[var1]);
            } else {
                DevicePcmPlayerProvider.method89(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12,
                        var13, field2161[var20], field2161[var21], field2161[var22], field2175[var20], field2175[var21],
                        field2175[var22], field2200[var20], field2200[var21], field2200[var22],
                        this.faceTextures[var1]);
            }
        } else {
            ...
            if (this.faceColors3[var1] == -1 && var14) {
                ...
                Rasterizer3D.field1999.method1231(var2, var3, var4, var5, var6, var7, var8, var9, var10, var21, var16,
                        var17, var18, var19);
            } else if (this.faceColors3[var1] == -1) {
                class144.method825(var2, var3, var4, var5, var6, var7, var8, var9, var10,
                        field2140[this.faceColors1[var1]]);
            } else if (var14) {
                byte var15 = this.overrideHue;
                var16 = this.overrideSaturation;
                var17 = this.overrideLuminance;
                var18 = this.overrideAmount;
                Rasterizer3D.field1999.method1224(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12,
    ...
    final void method1334(int var1) {
        ...
        if (var8 >= 50) {
            ...
            if (var10 >= 50) {
                ...
                field2184[var4] = var2
                        + (var11 + ((field2161[var7] - var11) * var14 >> 16)) * UserComparator7.get3dZoom() / 50;
                field2185[var4] = var3
                        + (var12 + ((field2175[var7] - var12) * var14 >> 16)) * UserComparator7.get3dZoom() / 50;
            ...
            if (var9 >= 50) {
                ...
                field2184[var4] = var2
                        + (var11 + ((field2161[var6] - var11) * var14 >> 16)) * UserComparator7.get3dZoom() / 50;
                field2185[var4] = var3
                        + (var12 + ((field2175[var6] - var12) * var14 >> 16)) * UserComparator7.get3dZoom() / 50;
                field2150[var4] = field2198;
        ...
        if (var9 >= 50) {
            ...
            if (var8 >= 50) {
                ...
                field2184[var4] = var2
                        + (var11 + ((field2161[var5] - var11) * var14 >> 16)) * UserComparator7.get3dZoom() / 50;
                field2185[var4] = var3
                        + (var12 + ((field2175[var5] - var12) * var14 >> 16)) * UserComparator7.get3dZoom() / 50;
                field2150[var4] = field2198;
        ...
        if (var4 == 3) {
            ...
            this.method1332(var1, var14, var15, var16, var11, var12, var13, var17, var18, var19, field2186[0],
                    field2186[1], field2186[2]);
        }

        if (var4 == 4) {
            if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > var20 || var12 > var20 || var13 > var20
                    || field2184[3] < 0 || field2184[3] > var20) {
                Rasterizer3D.clips.field2234 = true;
            }
            ...
            if (this.faceTextures != null && this.faceTextures[var1] != -1) {
                ...
                if (this.faceColors3[var1] == -1) {
                    DevicePcmPlayerProvider.method89(var14, var15, var16, var11, var12, var13, var17, var18, var19,
                            this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field2161[var38],
                            field2161[var22], field2161[var23], field2175[var38], field2175[var22], field2175[var23],
                            field2200[var38], field2200[var22], field2200[var23], var41);
                    DevicePcmPlayerProvider.method89(var14, var16, field2185[3], var11, var13, field2184[3], var17,
                            var19, field2150[3], this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1],
                            field2161[var38], field2161[var22], field2161[var23], field2175[var38], field2175[var22],
                            field2175[var23], field2200[var38], field2200[var22], field2200[var23], var41);
                } else {
                    DevicePcmPlayerProvider.method89(var14, var15, var16, var11, var12, var13, var17, var18, var19,
                            field2186[0], field2186[1], field2186[2], field2161[var38], field2161[var22],
                            field2161[var23], field2175[var38], field2175[var22], field2175[var23], field2200[var38],
                            field2200[var22], field2200[var23], var41);
                    DevicePcmPlayerProvider.method89(var14, var16, field2185[3], var11, var13, field2184[3], var17,
                            var19, field2150[3], field2186[0], field2186[2], field2186[3], field2161[var38],
                            field2161[var22], field2161[var23], field2175[var38], field2175[var22], field2175[var23],
                            field2200[var38], field2200[var22], field2200[var23], var41);
                }
            } else {
                ...
                if (this.faceColors3[var1] == -1 && var21) {
                    ...
                    Rasterizer3D.field1999.method1231(var14, var15, var16, var11, var12, var13, var17, var18, var19,
                            var22, var39, var40, var25, var26);
                    ...
                    Rasterizer3D.field1999.method1231(var14, var16, var42, var11, var13, var43, var17, var19, var44,
                            var22, var45, var46, var47, var48);
                } else if (this.faceColors3[var1] == -1) {
                    var22 = field2140[this.faceColors1[var1]];
                    class144.method825(var14, var15, var16, var11, var12, var13, var17, var18, var19, var22);
                    class144.method825(var14, var16, field2185[3], var11, var13, field2184[3], var17, var19,
                            field2150[3], var22);
                } else if (var21) {
                    var22 = field2186[0];
                    var23 = field2186[1];
                    ...
                    Rasterizer3D.field1999.method1224(var14, var15, var16, var11, var12, var13, var17, var18, var19,
                    ...
                    Rasterizer3D.field1999.method1224(var14, var16, var29, var11, var13, var30, 0.0F, 0.0F, 0.0F, var31,
                            var32, var33, var34, var35, var36, var37);
                } else {
                    BoundaryObject.method1379(var14, var15, var16, var11, var12, var13, var17, var18, var19,
                            field2186[0], field2186[1], field2186[2]);
                    BoundaryObject.method1379(var14, var16, field2185[3], var11, var13, field2184[3], var17, var19,
                            field2150[3], field2186[0], field2186[2], field2186[3]);
                }
            }
        }
    ...
    void method1326(int var1, class425 var2) {
        ...
        float var6 = 1.0F;
        this.verticesX[var1] = (int) (var2.field3797[0] * var3 + var2.field3797[4] * var4 + var2.field3797[8] * var5
                + var2.field3797[12] * var6);
        this.verticesY[var1] = -((int) (var2.field3797[1] * var3 + var2.field3797[5] * var4 + var2.field3797[9] * var5
                + var2.field3797[13] * var6));
        this.verticesZ[var1] = -((int) (var2.field3797[2] * var3 + var2.field3797[6] * var4 + var2.field3797[10] * var5
                + var2.field3797[14] * var6));
    }
