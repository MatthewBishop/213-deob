public class class33 {
    ...
    static LoginPacket[] method145() {
        return new LoginPacket[] { LoginPacket.RECONNECT_LOGIN_CONNECTION, LoginPacket.field2704, LoginPacket.field2701,
                LoginPacket.NEW_LOGIN_CONNECTION, LoginPacket.field2705, LoginPacket.field2700 };
    }
    ...
    static void method151(GameEngine var0) {
        ...
        while (var2.method1154()) {
            ...
            } else if (var2.field1867 == 97 && Login.worldSelectPage < Login.worldSelectPagesCount
                    && class13.worldSelectRightSprite != null) {
                ++Login.worldSelectPage;
            }
        }
        ...
        if (MouseHandler.MouseHandler_lastButton == 1
            ...
            if (Login.worldSelectPage > 0 && PlayerType.worldSelectLeftSprite != null
                    ...
                    && MouseHandler.MouseHandler_lastPressedX <= PlayerType.worldSelectLeftSprite.subWidth
                    && MouseHandler.MouseHandler_lastPressedY >= class262.canvasHeight / 2 - 50
                    && MouseHandler.MouseHandler_lastPressedY <= class262.canvasHeight / 2 + 50) {
                --Login.worldSelectPage;
            }

            if (Login.worldSelectPage < Login.worldSelectPagesCount && class13.worldSelectRightSprite != null
                    && MouseHandler.MouseHandler_lastPressedX >= GameEngine.canvasWidth
                            - class13.worldSelectRightSprite.subWidth - 5
                    && MouseHandler.MouseHandler_lastPressedX <= GameEngine.canvasWidth
                    && MouseHandler.MouseHandler_lastPressedY >= class262.canvasHeight / 2 - 50
                    && MouseHandler.MouseHandler_lastPressedY <= class262.canvasHeight / 2 + 50) {
                ++Login.worldSelectPage;
    ...
    static int method147(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 2800) {
            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class195
                    .Widget_unpackTargetMask(KeyHandler.getWidgetFlags(var3));
            return 1;
        } else if (var0 != 2801) {
            if (var0 == 2802) {
        ...
        if (var0 != null && var0.isVisible()) {
            ...
            if (var0.overheadText != null && (!var8 || !var0.showPublicPlayerChat && (Client.publicChatMode == 4
                ...
                if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) {
                    Client.overheadTextXOffsets[Client.overheadTextCount] = class137.fontBold12
            ...
            if (!var0.healthBars.method1971()) {
                ...
                for (HealthBar var76 = (HealthBar) var0.healthBars
                        .last(); var76 != null; var76 = (HealthBar) var0.healthBars.previous()) {
                    ...
                    if (var11 == null) {
                        ...
                        if (var13 != null && var14 != null) {
                            ...
                            if (Client.viewportTempX > -1) {
                                ...
                                Rasterizer2D.Rasterizer2D_fillRectangle(var21 + var95, var22, var15 - var95, 5,
                                        16711680);
                            }
            ...
            if (var8 && var0.playerCycle == Client.cycle && class13.method46((Player) var0)) {
                ...
                if (var8) {
                    ...
                    var9 += 4;
                    var91.drawCentered(var97.username.getName(), var2 + Client.viewportTempX,
            ...
            if (var8) {
                ...
                if (var97.headIconPk != -1 || var97.headIconPrayer != -1) {
                    ...
                    if (Client.viewportTempX > -1) {
                        if (var97.headIconPk != -1) {
                            var9 += 25;
                            class36.headIconPkSprites[var97.headIconPk].drawTransBgAt(var2 + Client.viewportTempX - 12,
                                    var3 + Client.viewportTempY - var9);
                        }

                        if (var97.headIconPrayer != -1) {
                            var9 += 25;
                            class425.headIconPrayerSprites[var97.headIconPrayer].drawTransBgAt(
                ...
                if (var1 >= 0 && Client.hintArrowType == 10 && var7[var1] == Client.hintArrowPlayerIndex) {
                    ...
                    if (Client.viewportTempX > -1) {
                        ...
                        KitDefinition.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12,
                                var3 + Client.viewportTempY - var9);
                    }
                }
            } else {
                    ...
                    for (var78 = 0; var78 < var92.length; ++var78) {
                        if (var92[var78] >= 0 && var90[var78] >= 0) {
                            ...
                            if (var81 != null) {
                                UserComparator6.method716(var0, var0.defaultHeight + 15);
                                if (Client.viewportTempX > -1) {
                                    var81.drawTransBgAt(var2 + Client.viewportTempX - (var81.subWidth >> 1),
                                            Client.viewportTempY + (var3 - var81.subHeight) - 4);
                                }
                            }
                        }
                    }
                ...
                if (Client.hintArrowType == 1 && Client.npcIndices[var1 - var75] == Client.hintArrowNpcIndex
                    ...
                    if (Client.viewportTempX > -1) {
                        KitDefinition.headIconHintSprites[0].drawTransBgAt(var2 + Client.viewportTempX - 12,
