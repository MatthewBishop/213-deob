...
public class PlayerComposition {
    ...
    static {
        equipmentIndices = new int[] { class204.field1839.field1831, class204.field1840.field1831,
                class204.field1835.field1831, class204.field1837.field1831, class204.field1834.field1831,
                class204.field1838.field1831, class204.field1843.field1831 };
    ...
    PlayerComposition(PlayerComposition var1) {
        ...
        ObjTypeCustomisation[] var4 = (ObjTypeCustomisation[]) (var1.customisations != null
                ? (ObjTypeCustomisation[]) Arrays.copyOf(var1.customisations, var1.customisations.length)
                : null);
    ...
    public void method1692(int[] var1, int[] var2, ObjTypeCustomisation[] var3, boolean var4, int[] var5, int var6,
            int var7, int var8) {
    ...
    public Model getModel(SequenceDefinition var1, int var2, SequenceDefinition var3, int var4) {
        if (this.npcTransformId != -1) {
            return AbstractArchive.getNpcDefinition(this.npcTransformId).method1021(var1, var2, var3, var4,
                    (NewShit) null);
        } else {
            long var5 = this.hash;
                ...
                if (var18 == null) {
                    ...
                    for (var13 = 0; var13 < 5; ++var13) {
                        ...
                        if (this.bodyColors[var13] < class437.field3825[var13].length) {
                            var20.recolor(WorldMapIcon_0.field2359[var13],
                                    class437.field3825[var13][this.bodyColors[var13]]);
                        }
                    }
    ...
    public int getChatHeadId() {
        return this.npcTransformId == -1
                ...
                : 305419896 + AbstractArchive.getNpcDefinition(this.npcTransformId).id;
    }
