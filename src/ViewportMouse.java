public class ViewportMouse {
    ...
    static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6,
        ...
        for (int var8 = 0; var8 < var0.length; ++var8) {
            ...
            if (var9 != null && var9.parentId == var1 && (var9.method1801() || KeyHandler.getWidgetFlags(var9) != 0
                    || var9 == Client.clickedWidgetParent)) {
                if (var9.isIf3) {
                    if (class393.isComponentHidden(var9)) {
                        continue;
                    }
                } else if (var9.type == 0 && var9 != MidiPcmStream.mousedOverWidgetIf1
                        && class393.isComponentHidden(var9)) {
                    continue;
                }
                ...
                if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
                    ...
                    if (var9.contentType == 1337) {
                        ...
                        if (var9.contentType == 1400) {
                            class126.worldMap.onCycle(MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y, var35,
                                    var26, var11, var9.width, var9.height);
                        }

                        if (!Client.isMenuOpen && var35) {
                            if (var9.contentType == 1400) {
                                class126.worldMap.addElementMenuOptions(var26, var11, var9.width, var9.height, var17,
                                        var18);
                            } else {
                        ...
                        if (var34) {
                            for (int var20 = 0; var20 < var9.field2954.length; ++var20) {
                                    ...
                                    for (var23 = 0; var23 < var9.field2954[var20].length; ++var23) {
                                        ...
                                        if (var9.field2952 != null) {
                                            var24 = Client.keyHandlerInstance
                                                    .getKeyPressed(var9.field2954[var20][var23]);
                                        }
                                ...
                                if (var22) {
                                    if (var20 < 10) {
                                        Message.widgetDefaultMenuAction(var20 + 1, var9.id, var9.childIndex,
                                                var9.itemId, "");
                                    } else if (var20 == 10) {
                                        class166.Widget_runOnTargetLeave();
                                        class18.selectSpell(var9.id, var9.childIndex,
                                                class195.Widget_unpackTargetMask(KeyHandler.getWidgetFlags(var9)),
                                                var9.itemId);
                        ...
                        if (var9.isIf3) {
                            ...
                            if ((MouseHandler.MouseHandler_currentButton == 1
                                    || !class473.mouseCam && MouseHandler.MouseHandler_currentButton == 4) && var35) {
                                var36 = true;
                            }
                            ...
                            if (var21) {
                                class370.clickWidget(var9, MouseHandler.MouseHandler_lastPressedX - var26,
                                        MouseHandler.MouseHandler_lastPressedY - var11);
                            }

                            if (var9.method1808()) {
                                if (var21) {
                                    Client.field569.addFirst(new class206(0, MouseHandler.MouseHandler_x - var26,
                                            MouseHandler.MouseHandler_y - var11, var9));
                                }

                                if (var36) {
                                    Client.field569.addFirst(new class206(1, MouseHandler.MouseHandler_x - var26,
                                            MouseHandler.MouseHandler_y - var11, var9));
                                }
                            }
                            ...
                            if (Client.clickedWidget != null && var9 != Client.clickedWidget && var35
                                    && MusicPatchNode.method1676(KeyHandler.getWidgetFlags(var9))) {
                            ...
                            if (var9.hasListener) {
                                ...
                                if (var9.onVarTransmit != null && Client.changedVarpCount > var9.field2870) {
                                    if (var9.varTransmitTriggers != null
                                            && Client.changedVarpCount - var9.field2870 <= 32) {
                                        label647: for (var37 = var9.field2870; var37 < Client.changedVarpCount; ++var37) {
                                ...
                                if (var9.onInvTransmit != null && Client.changedItemContainersCount > var9.field3017) {
                                    if (var9.invTransmitTriggers != null
                                            && Client.changedItemContainersCount - var9.field3017 <= 32) {
                                        label623: for (var37 = var9.field3017; var37 < Client.changedItemContainersCount; ++var37) {
                                ...
                                if (var9.onStatTransmit != null && Client.changedSkillsCount > var9.field3006) {
                                    if (var9.statTransmitTriggers != null
                                            && Client.changedSkillsCount - var9.field3006 <= 32) {
                                        label599: for (var37 = var9.field3006; var37 < Client.changedSkillsCount; ++var37) {
                        ...
                        if (!var9.isIf3) {
                            ...
                            if (var9.scrollHeight > var9.height) {
                                class166.method944(var9, var26 + var9.width, var11, var9.height, var9.scrollHeight,
                        ...
                        if (var9.type == 0) {
                            ...
                            if (var32 != null) {
                                ...
                                ReflectionCheck.updateRootInterface(var32.group, var12, var13, var14, var15, var26,
                                        var11);
                            }
                        }
                    }
