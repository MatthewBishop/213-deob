            ...
            if (Client.menuOptionsCount < 400) {
                ...
                if (var0.skillLevel == 0) {
                    var4 = var0.actions[0] + var0.username + var0.actions[1]
                            + ItemContainer.method480(var0.combatLevel, MusicPatchNode.localPlayer.combatLevel) + " "
                ...
                if (Client.isItemSelected == 1) {
                    MenuAction.insertMenuItemNoShift("Use",
                            Client.field364 + " " + "->" + " " + class383.colorStartTag(16777215) + var4, 14, var1,
                            var2, var3);
                } else if (Client.isSpellSelected) {
                    if ((SecureRandomFuture.selectedSpellFlags & 8) == 8) {
                        MenuAction.insertMenuItemNoShift(Client.field530,
                                Client.field522 + " " + "->" + " " + class383.colorStartTag(16777215) + var4, 15, var1,
                                var2, var3);
                    }
                } else {
                    for (var5 = 7; var5 >= 0; --var5) {
                        if (Client.playerMenuActions[var5] != null) {
                            ...
                            if (Client.playerMenuActions[var5].equalsIgnoreCase("Attack")) {
                                ...
                                if (Client.playerAttackOption == AttackOption.AttackOption_alwaysRightClick
                                        || AttackOption.AttackOption_dependsOnCombatLevels == Client.playerAttackOption
                                                && var0.combatLevel > MusicPatchNode.localPlayer.combatLevel) {
                                    var6 = 2000;
                                }
                            ...
                            MenuAction.insertMenuItemNoShift(Client.playerMenuActions[var5],
                                    class383.colorStartTag(16777215) + var4, var8, var1, var2, var3);
                        }
                    }
                }
    ...
    static final void drawCompass(Widget var0, int var1, int var2, int var3) {
        ...
        if (var4 != null) {
            if (Client.minimapState < 3) {
                ChatChannel.compass.drawRotatedMaskedCenteredAround(var1, var2, var4.width, var4.height, 25, 25,
