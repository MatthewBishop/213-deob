...
public class class144 extends class139 {
    ...
    public static int method818(int var0, int var1, int var2, RouteStrategy var3, CollisionMap var4, boolean var5,
            int[] var6, int[] var7) {
        int var9;
        ...
        if (var2 == 1) {
            ...
            while (true) {
                ...
                if (var30 > 0 && class211.directions[var30 - 1][var31] == 0 && (var18[var19 - 1][var20] & 19136782) == 0
                ...
                if (var30 < 126 && class211.directions[var30 + 1][var31] == 0
                ...
                if (var31 > 0 && class211.directions[var30][var31 - 1] == 0 && (var18[var19][var20 - 1] & 19136782) == 0
                ...
                if (var31 < 126 && class211.directions[var30][var31 + 1] == 0
                ...
                if (var30 > 0 && var31 > 0 && class211.directions[var30 - 1][var31 - 1] == 0
                ...
                if (var30 < 126 && var31 > 0 && class211.directions[var30 + 1][var31 - 1] == 0
                        && (var18[var19 + 1][var20 - 1] & 19136911) == 0
                        && (var18[var19 + 2][var20 - 1] & 19136899) == 0 && (var18[var19 + 2][var20] & 19136995) == 0) {
                    class211.bufferX[var33] = var10 + 1;
                    class211.bufferY[var33] = var11 - 1;
                    var33 = var33 + 1 & 4095;
                ...
                if (var30 > 0 && var31 < 126 && class211.directions[var30 - 1][var31 + 1] == 0
                        && (var18[var19 - 1][var20 + 1] & 19136830) == 0
                ...
                if (var30 < 126 && var31 < 126 && class211.directions[var30 + 1][var31 + 1] == 0
            ...
            for (var20 = var33 - var32; var20 <= var33 + var32; ++var20) {
                for (var21 = var17 - var32; var21 <= var17 + var32; ++var21) {
                    ...
                    if (var22 >= 0 && var23 >= 0 && var22 < 128 && var23 < 128
                            && class211.distances[var22][var23] < 100) {
                        int var24 = 0;
                        if (var20 < var33) {
                            var24 = var33 - var20;
        ...
        if (var0 == var11 && var30 == var1) {
            ...
            for (var14 = var15 = class211.directions[var11 - var9][var30 - var10]; var0 != var11
                    || var30 != var1; var14 = class211.directions[var11 - var9][var30 - var10]) {
                if (var14 != var15) {
                    var15 = var14;
        ...
        for (int var4 = var1; var4 < var2 + var1; var4 += 3) {
            ...
            if (var4 < var2 - 1) {
                ...
                if (var4 < var2 - 2) {
                    ...
                    var3.append(class370.field3593[(var6 & 15) << 2 | var7 >>> 6])
                            .append(class370.field3593[var7 & 63]);
                } else {
    ...
    public static void method825(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7,
            float var8, int var9) {
        ...
        if (var0 != 7500 && var0 != 7508) {
                        ...
                        for (var15 = var12; var15 < var13; ++var15) {
                            ...
                            if (var17 == class478.field4026) {
                                ...
                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                        - 1] = GrandExchangeOfferUnitPriceComparator.method1933(var16);
                            }
                        }
            ...
            if (var22 == null) {
                ...
                if (class9.field21 != null) {
                    ...
                    class1.field4 = class9.field21.iterator();
                    if (var0 == 7500) {
                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class9.field21
                                .size();
                    }
                } else {
                    Client.field613 = -1;
