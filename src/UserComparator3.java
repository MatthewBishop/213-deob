...
public class UserComparator3 extends AbstractUserComparator {
        ...
        for (int var3 = 0; var3 < var2.size; ++var3) {
            try {
                ...
                if (var4 != 0 && var4 != 1 && var4 != 2) {
                    ...
                    var2.field158[var3] = class33.loadClassFromDescriptor(var5).getDeclaredField(var6);
                }
    ...
    static int method700(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 4000) {
            ...
            if (var0 == 4006) {
                ...
                var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
                var5 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2];
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class134.method780(var3,
                        var4, var5);
                return 1;
            } else if (var0 == 4028) {
                Interpreter.Interpreter_intStackSize -= 3;
                ...
                var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
                var5 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2];
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Canvas.method91(var3,
                        var4, var5);
                return 1;
            } else if (var0 == 4029) {
                Interpreter.Interpreter_intStackSize -= 3;
                ...
                Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1] = AttackOption
                        .method621(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1]);
                return 1;
            } else if (var0 == 4033) {
                Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1] = TriBool
                        .method2198(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize - 1]);
                return 1;
            } else if (var0 == 4034) {
                Interpreter.Interpreter_intStackSize -= 2;
                var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
    ...
    static final int method702() {
        if (class20.clientPreferences.getRoofsHidden()) {
            ...
            if (MusicPatchNode.localPlayer.x >= 0 && MusicPatchNode.localPlayer.y >= 0
                    && MusicPatchNode.localPlayer.x < 13312 && MusicPatchNode.localPlayer.y < 13312) {
                if ((Tiles.Tiles_renderFlags[GameEngine.Client_plane][MusicPatchNode.localPlayer.x >> 7][MusicPatchNode.localPlayer.y >> 7]
                        & 4) != 0) {
                    var0 = GameEngine.Client_plane;
                }
