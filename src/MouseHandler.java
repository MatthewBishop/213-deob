        ...
        if (var0 == 2600) {
            ...
            if (var0 == 2617) {
                ...
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var4 != null
                        ? var4.field2818 * -90398499 * 202848117
                        : 0;
            }
            ...
            if (var0 == 2618) {
                var4 = var3.method1817();
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var4 != null
                        ? var4.field2816 * 216034339 * -1464228981
                        : 0;
                return 1;
            } else {
                class314 var7;
                if (var0 == 2619) {
                    ...
                    Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
                            - 1] = var7 != null ? var7.method1741().method2007() : "";
                    return 1;
                } else if (var0 == 2620) {
                    var4 = var3.method1817();
                    Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var4 != null
                            ? var4.field2817 * -1652794843 * 1912484269
                            : 0;
                    return 1;
                } else if (var0 == 2621) {
                    var7 = var3.method1815();
                    ...
                    if (var0 == 2626) {
                        var7 = var3.method1815();
                        Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
                                - 1] = var7 != null ? var7.method1742().method2083() : "";
                        return 1;
                    } else if (var0 == 2627) {
                        var7 = var3.method1815();
        ...
        if (var0 != null && var0.isVisible() && !var0.isHidden) {
            ...
            if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
                ...
                if (var0.attachedModel != null && Client.cycle >= var0.animationCycleStart
                    ...
                    class31.scene.addNullableObject(GameEngine.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0,
                    ...
                    var0.tileHeight = class147.getTileHeight(var0.x, var0.y, GameEngine.Client_plane);
                    var0.playerCycle = Client.cycle;
                    class31.scene.drawEntity(GameEngine.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0,
