                ...
                if (var4.isInteractable) {
                    if (!var4.isFollower || Client.followerIndex == var1) {
                        ...
                        if (var4.combatLevel != 0 && var0.combatLevelChange != 0) {
                            var6 = var0.combatLevelChange != -1 ? var0.combatLevelChange * 1392091407 * 674049519
                                    : var4.combatLevel * 2062903815 * -959716425;
                            var5 = var5 + ItemContainer.method480(var6, MusicPatchNode.localPlayer.combatLevel) + " "
                                    + " (" + "level-" + var6 + ")";
                        }

                        if (var4.isFollower && Client.followerOpsLowPriority) {
                            MenuAction.insertMenuItemNoShift("Examine", class383.colorStartTag(16776960) + var5, 1003,
                                    var1, var2, var3);
                        }

                        if (Client.isItemSelected == 1) {
                            MenuAction.insertMenuItemNoShift("Use",
                                    Client.field364 + " " + "->" + " " + class383.colorStartTag(16776960) + var5, 7,
                                    var1, var2, var3);
                        } else if (Client.isSpellSelected) {
                            if ((SecureRandomFuture.selectedSpellFlags & 2) == 2) {
                                MenuAction.insertMenuItemNoShift(Client.field530,
                                        Client.field522 + " " + "->" + " " + class383.colorStartTag(16776960) + var5, 8,
                                        var1, var2, var3);
                            }
                        } else {
                            ...
                            if (var7 != null) {
                                for (var8 = 4; var8 >= 0; --var8) {
                                    if (var0.method604(var8) && var7[var8] != null
                                        ...
                                        MenuAction.insertMenuItemNoShift(var7[var8],
                                                class383.colorStartTag(16776960) + var5, var9, var1, var2, var3);
                                    }
                                }
                            }
                                        ...
                                        if (AttackOption.AttackOption_hidden != Client.npcAttackOption) {
                                            if (AttackOption.AttackOption_alwaysRightClick == Client.npcAttackOption
                                                    || Client.npcAttackOption == AttackOption.AttackOption_dependsOnCombatLevels
                                                            && var4.combatLevel > MusicPatchNode.localPlayer.combatLevel) {
                                                var10 = 2000;
                                            }
                            ...
                            if (!var4.isFollower || !Client.followerOpsLowPriority) {
                                MenuAction.insertMenuItemNoShift("Examine", class383.colorStartTag(16776960) + var5,
                                        1003, var1, var2, var3);
                            }
                        }
