            ...
            for (var11 = -5; var11 < 109; ++var11) {
                for (var12 = 0; var12 < 104; ++var12) {
                    ...
                    if (var13 >= 0 && var13 < 104) {
                        ...
                        if (var15 > 0) {
                            var17 = var15 - 1;
                            FloorUnderlayDefinition var46 = (FloorUnderlayDefinition) FloorUnderlayDefinition.FloorUnderlayDefinition_cached
                                    .get((long) var17);
                            FloorUnderlayDefinition var47;
                            if (var46 != null) {
                                var47 = var46;
                            } else {
                                byte[] var48 = FloorUnderlayDefinition.FloorUnderlayDefinition_archive.takeFile(1,
                                        var17);
                    ...
                    if (var14 >= 0 && var14 < 104) {
                        ...
                        if (var16 > 0) {
                            var18 = var16 - 1;
                            FloorUnderlayDefinition var62 = (FloorUnderlayDefinition) FloorUnderlayDefinition.FloorUnderlayDefinition_cached
                                    .get((long) var18);
                            FloorUnderlayDefinition var49;
                            if (var62 != null) {
                                var49 = var62;
                            } else {
                                byte[] var50 = FloorUnderlayDefinition.FloorUnderlayDefinition_archive.takeFile(1,
                                        var18);
                            ...
                            if (var21 > 0 || var22 > 0) {
                                ...
                                if (var22 == 0) {
                                    var0.addTile(var2, var11, var17, 0, 0, -1, var23, var24, var25, var26,
                                            method41(var31, var27), method41(var31, var28), method41(var31, var29),
                                            method41(var31, var30), 0, 0, 0, 0, var33, 0);
                                } else {
                                    ...
                                    int var43;
                                    if (var53 >= 0) {
                                        var41 = Rasterizer3D.clips.Rasterizer3D_textureLoader
                                                .getAverageTextureRGB(var53);
                                        var40 = -1;
                                    ...
                                    var0.addTile(var2, var11, var17, var34, var61, var53, var23, var24, var25, var26,
                                            method41(var31, var27), method41(var31, var28), method41(var31, var29),
                                            method41(var31, var30), class478.method2437(var40, var27),
                                            class478.method2437(var40, var28), class478.method2437(var40, var29),
                                            class478.method2437(var40, var30), var33, var42);
                                }
                            }
                        }
                    }
                ...
                for (int var57 = 0; var57 <= 104; ++var57) {
                    for (int var58 = 0; var58 <= 104; ++var58) {
                        ...
                        if ((class161.field1407[var56][var58][var57] & var2) != 0) {
                            ...
                            for (var12 = var56; var9 > 0
                                    && (class161.field1407[var56][var58][var9 - 1] & var2) != 0; --var9) {
                                ;
                            }
                            ...
                            if (var13 >= 8) {
                                ...
                                Scene.Scene_addOccluder(var5, 1, var58 * 128, var58 * 128, var9 * 128,
                        ...
                        if ((class161.field1407[var56][var58][var57] & var3) != 0) {
                            ...
                            for (var12 = var56; var9 > 0
                                    && (class161.field1407[var56][var9 - 1][var57] & var3) != 0; --var9) {
                                ;
                            }
                            ...
                            if (var13 >= 8) {
                                ...
                                Scene.Scene_addOccluder(var5, 2, var9 * 128, var10 * 128 + 128, var57 * 128,
                                        var57 * 128, var15, var16);
                        ...
                        if ((class161.field1407[var56][var58][var57] & var4) != 0) {
                            ...
                            for (var12 = var57; var11 > 0
                                    && (class161.field1407[var56][var58][var11 - 1] & var4) != 0; --var11) {
                                ;
                            }
