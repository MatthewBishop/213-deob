...
class class11 implements TlsAuthentication {
    ...
    public void notifyServerCertificate(Certificate var1) throws IOException {
        try {
            ...
            this.this$2.this$1.field40 = (java.security.cert.Certificate[]) ((java.security.cert.Certificate[]) var3
            ...
            if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
                ...
                if (!var10.isIf3 || !class393.isComponentHidden(var10)) {
                    ...
                    if (!var10.isIf3 || var15 < var17 && var16 < var18) {
                        if (var10.contentType != 0) {
                            if (var10.contentType == 1336) {
                                if (class20.clientPreferences.method562()) {
                                    var13 += 15;
                                    WallDecoration.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps,
                                    ...
                                    WallDecoration.fontPlain12.drawRightAligned("Mem:" + var20 + "k",
                                            var12 + var10.width, var13, var21, -1);
                                    var13 += 15;
                                }
                                continue;
                            }
                        ...
                        if (var10.type == 0) {
                            if (!var10.isIf3 && class393.isComponentHidden(var10)
                                    && var10 != MidiPcmStream.mousedOverWidgetIf1) {
                                continue;
                            }
                        ...
                        if (Client.isResizable || Client.field519[var11] || Client.gameDrawingMode > 1) {
                            if (var10.type == 0 && !var10.isIf3 && var10.scrollHeight > var10.height) {
                                class103.drawScrollBar(var12 + var10.width, var13, var10.scrollY, var10.height,
                                        var10.scrollHeight);
                            }
                            ...
                            if (var10.type != 1) {
                                if (var10.type == 3) {
                                    ...
                                    if (var40 == null) {
                                        ...
                                        if (class452.runCs1(var10)) {
                                            var20 = var10.color2;
                                            if (var10 == MidiPcmStream.mousedOverWidgetIf1
                                        ...
                                        if (var10.isIf3 && var10.itemId != -1) {
                                            ...
                                            if ((var43.isStackable == 1 || var10.itemQuantity != 1)
                                                ...
                                                var42 = class383.colorStartTag(16748608) + var42 + "</col>" + " " + 'x'
                                                        + ArchiveDiskAction.formatItemStacks(var10.itemQuantity);
                                            }
                                        }
                                        ...
                                        var40.method2055(var42, var12, var13, var10.width, var10.height, var20,
                                                var10.textShadowed ? 0 : -1, Decimator.method332(var10.transparencyTop),
                                    ...
                                    if (var10.type == 5) {
                                        ...
                                        if (!var10.isIf3) {
                                            ...
                                            if (var10.itemId != -1) {
                                                var38 = class252.getItemSprite(var10.itemId, var10.itemQuantity,
                                            ...
                                            if (var38 == null) {
                                                ...
                                                if (!var10.spriteTiling) {
                                                    ...
                                                    if (var10.spriteAngle != 0) {
                                                        var38.method2632(var10.width / 2 + var12,
                                                    ...
                                                    for (var24 = 0; var24 < var22; ++var24) {
                                                        for (var25 = 0; var25 < var23; ++var25) {
                                                            if (var10.spriteAngle != 0) {
                                                                var38.method2632(var20 / 2 + var12 + var24 * var20,
                                        ...
                                        if (var10.type == 6) {
                                            ...
                                            var22 = 0;
                                            if (var10.itemId != -1) {
                                                ItemComposition var44 = HealthBarUpdate
                                                ...
                                                var39 = var10.field2894.getModel((SequenceDefinition) null, -1,
                                                        ItemContainer.SequenceDefinition_get(
                                                                MusicPatchNode.localPlayer.idleSequence),
                                                        MusicPatchNode.localPlayer.movementFrame);
                                            } else {
                                                ...
                                                var39 = var10.getModel(var33, var34, var36,
                                                        MusicPatchNode.localPlayer.appearance, var45, var32);
                                            ...
                                            if (var39 != null) {
                                                if (!var10.isIf3) {
                                                    var39.method1343(0, var10.modelAngleY, 0, var10.modelAngleX, 0,
                                                            var23, var24);
                                                } else {
                                                    var39.calculateBoundsCylinder();
                                                    if (var10.modelOrthog) {
                                                        var39.method1327(0, var10.modelAngleY, var10.modelAngleZ,
                                                                var10.modelAngleX, var10.modelOffsetX,
                                                                var23 + var22 + var10.modelOffsetY,
                                                                var24 + var10.modelOffsetY, var10.modelZoom);
                                                    } else {
                                                        var39.method1343(0, var10.modelAngleY, var10.modelAngleZ,
                                                                var10.modelAngleX, var10.modelOffsetX,
                                                                var23 + var22 + var10.modelOffsetY,
                                            ...
                                            Font var29;
                                            if (var10.type == 8 && var10 == class130.field1274
                                                ...
                                                String var31;
                                                for (var30 = class121.method720(var30, var10); var30
                                            ...
                                            if (var10.type == 9) {
                                                ...
                                                if (var10.lineWid == 1) {
                                                    ...
                                                    class36.method196(var19, var20, var21, var22, var10.color,
                                                            var10.lineWid);
                                                }
                                                ...
                                                if (var37 != null && var35 != null && var37.method1748()) {
                                                    var29 = var10.getFont();
                                                    if (var29 != null) {
                                                        Client.field565.method2637(var12, var13, var10.width,
                                                                var10.height, var37.method1769(), var37.method1781(),
                                                                var37.method1746(), var37.method1747(),
                                                                var37.method1745());
                                                        var22 = var10.textShadowed
                                                                ? var10.spriteShadow * -140657215 * -353676735
                                                                : -1;
                                                        if (!var37.method1743() && var37.method1740().method2004()) {
                                                            Client.field565.method2639(var35.field2817, var22,
                                                                    var35.field2818, var35.field2816);
                                                            Client.field565.method2638(var37.method1741(), var29);
                                                        } else {
                                                            Client.field565.method2639(var10.color, var22,
                                                                    var35.field2818, var35.field2816);
