    ...
    static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7,
        ...
        if (var2 == 25) {
            ...
            if (var17 != null) {
                ...
                class18.selectSpell(var1, var0, class195.Widget_unpackTargetMask(KeyHandler.getWidgetFlags(var17)),
                        var4);
                ...
                if (var17.isIf3) {
                    ...
                    Client.field522 = class383.colorStartTag(65280) + var17.field3004
                            + class383.colorStartTag(16777215);
                }
            }
