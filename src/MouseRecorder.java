    ...
    static int method496(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 6600) {
            ...
            if (var0 == 6601) {
                ...
                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class88.getWorldMap()
                        .getZoomLevel();
                return 1;
            } else if (var0 == 6604) {
                var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                ...
                if (var0 == 6606) {
                    ...
                    if (var0 == 6611) {
                        ...
                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class88
                        ...
                        if (var0 == 6618) {
                            ...
                            if (var0 == 6619) {
                                ...
                                class88.getWorldMap().setMaxFlashCount(
                                        Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                                return 1;
                            } else if (var0 == 6625) {
                                ...
                                class88.getWorldMap().setCyclesPerFlash(
                                        Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                                return 1;
                            } else if (var0 == 6627) {
                                ...
                                if (var0 == 6628) {
                                    ...
                                    if (var0 == 6633) {
                                        ...
                                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                - 1] = class88.getWorldMap().getElementsDisabled() ? 1 : 0;
                                        return 1;
                                    } else if (var0 == 6636) {
                                        var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                - 1] = class88.getWorldMap().isElementDisabled(var3) ? 1 : 0;
                                        return 1;
                                    } else if (var0 == 6637) {
                                        var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                        Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                - 1] = class88.getWorldMap().isCategoryDisabled(var3) ? 1 : 0;
                                        return 1;
                                    } else if (var0 == 6638) {
                                        Interpreter.Interpreter_intStackSize -= 2;
                                        var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
                                        ...
                                        if (var0 == 6639) {
                                            ...
                                            if (var0 == 6693) {
                                                ...
                                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                        - 1] = ByteArrayPool.worldMapEvent.mapElement;
                                                return 1;
                                            } else if (var0 == 6698) {
                                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                        - 1] = ByteArrayPool.worldMapEvent.coord1.packed();
                                                return 1;
                                            } else if (var0 == 6699) {
                                                Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                        - 1] = ByteArrayPool.worldMapEvent.coord2.packed();
                                                return 1;
                                            } else {
                                                return 2;
                                            }
