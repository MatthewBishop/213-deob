    ...
    static void drawTitle(Font var0, Font var1, Font var2) {
        ...
        if (Login.worldSelectOpen) {
            ...
            if (Client.gameState == 0 || Client.gameState == 5) {
                ...
                Rasterizer2D.Rasterizer2D_fillRectangle(Login.loginBoxX + 180 - 150 + Login.Login_loadingPercent * 3,
            ...
            if (Client.gameState == 20) {
                Login.titleboxSprite.drawAt(Login.loginBoxX + 180 - Login.titleboxSprite.subWidth / 2,
                        271 - Login.titleboxSprite.subHeight / 2);
                var22 = 201;
                ...
                if (Login.loginIndex != 4 && Login.loginIndex != 10) {
                    ...
                    for (var5 = class18.method74(); var0.stringWidth(var5) > var24; var5 = var5.substring(0,
                            var5.length() - 1)) {
                        ;
                    }
                    ...
                    for (var6 = WorldMapDecorationType.method1841(Login.Login_password); var0
                            .stringWidth(var6) > var24; var6 = var6.substring(1)) {
                        ;
                    }
                    ...
                    if (Login.loginIndex == 2) {
                        ...
                        var0.draw(AbstractFont.escapeBrackets(var5)
                                + (Login.currentLoginField == 0 & Client.cycle % 40 < 20
                                        ? class383.colorStartTag(16776960) + "|"
                                        : ""),
                                class143.loginBoxCenter - 70, var23, 16777215, 0);
                        var23 += 15;
                        ...
                        var0.draw("Password: " + var6
                                + (Login.currentLoginField == 1 & Client.cycle % 40 < 20
                                        ? class383.colorStartTag(16776960) + "|"
                                        : ""),
                                class143.loginBoxCenter - 108, var23, 16777215, 0);
                        var23 += 15;
                        var22 = 277;
                        var7 = class143.loginBoxCenter + -117;
                        boolean var9 = Client.Login_isUsernameRemembered;
                        boolean var10 = Login.field730;
                        IndexedSprite var8 = var9 ? (var10 ? Login.field745 : class158.options_buttons_2Sprite)
                                : (var10 ? Login.field733 : Login.options_buttons_0Sprite);
                        ...
                        IndexedSprite var12 = var13 ? (var14 ? Login.field745 : class158.options_buttons_2Sprite)
                                : (var14 ? Login.field733 : Login.options_buttons_0Sprite);
                        ...
                        class96.field1063 = new Bounds(class143.loginBoxCenter, var22,
                                var1.stringWidth(class18.field58), 11);
                        class19.field60 = new Bounds(class143.loginBoxCenter, var22,
                        ...
                        var23 = var22 + 20;
                        var1.drawCentered("If you have upgraded to a Jagex Account, you", Login.loginBoxX + 180, var23,
                                16776960, 0);
                        var23 += 20;
                        var1.drawCentered(
                                "need to log in using the <u=ffd200><col=ffd200>Jagex Launcher</col></u> instead.",
                                Login.loginBoxX + 180, var23, 16776960, 0);
                        var23 += 15;
                        ...
                        if (Login.loginIndex == 4) {
                            ...
                            var23 += 15;
                            var0.draw(
                                    "PIN: " + WorldMapDecorationType.method1841(Messages.otp)
                                            + (Client.cycle % 40 < 20 ? class383.colorStartTag(16776960) + "|" : ""),
                                    Login.loginBoxX + 180 - 108, var23, 16777215, 0);
                            var23 -= 8;
                            ...
                            var0.draw(
                                    AbstractFont.escapeBrackets(var5)
                                            + (Client.cycle % 40 < 20 ? class383.colorStartTag(16776960) + "|" : ""),
                                    Login.loginBoxX + 180 - 34, var23, 16777215, 0);
                            var23 += 15;
                            ...
                            var26 = 356;
                            var1.drawCentered("Still having trouble logging in?", class143.loginBoxCenter, var26,
                                    268435455, 0);
                            ...
                            if (WorldMapSectionType.field2384 && !Client.onMobile) {
                                ...
                                for (var27 = 0; var27 < 8; ++var27) {
                                    ...
                                    var0.draw(
                                            (Login.field748[var27] == null ? "" : Login.field748[var27])
                                                    + (var28 ? class383.colorStartTag(16776960) + "|" : ""),
                                            var4 + 10, var23 + 27, 16777215, 0);
                                    if (var27 != 1 && var27 != 3) {
                                        var4 += 35;
                                    } else {
                                        var4 += 50;
                                ...
                                var22 = 216;
                                var0.drawCentered("Your date of birth isn't set.", Login.loginBoxX + 180, var22,
                                        16776960, 0);
                                var23 = var22 + 15;
                                var2.drawCentered("Please verify your account status by", Login.loginBoxX + 180, var23,
                                        16776960, 0);
                                var23 += 15;
                                var2.drawCentered("setting your date of birth.", Login.loginBoxX + 180, var23, 16776960,
                                        0);
                                var23 += 15;
                                var4 = Login.loginBoxX + 180 - 80;
                                var17 = 321;
                            ...
                            var24 = 216;
                            var2.drawCentered("Before using this app, please read and accept our", var23, var24,
                                    16777215, 0);
                            var4 = var24 + 17;
                            var2.drawCentered(
                                    "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
                                    var23, var4, 16777215, 0);
                            var4 += 17;
                            ...
                            var2.drawCentered("You must accept our terms of use, privacy policy,",
                                    Login.loginBoxX + 180, var22, 16777215, 0);
                            var23 = var22 + 20;
                            ...
                            var22 = 216;
                            var0.drawCentered("Your date of birth isn't set.", Login.loginBoxX + 180, var22, 16776960,
                                    0);
                            var23 = var22 + 15;
                            var2.drawCentered("Please verify your account status by", Login.loginBoxX + 180, var23,
                                    16776960, 0);
            ...
            class148.title_muteSprite[class20.clientPreferences.getTitleMusicDisabled() ? 1 : 0]
            ...
            if (Client.gameState > 5 && Language.Language_EN == ClanSettings.clientLanguage) {
                if (class319.field3030 != null) {
                    ...
                    var0.drawCentered("World" + " " + Client.worldId, var31 / 2 + var23, var30 / 2 + var24 - 2,
                            16777215, 0);
                    ...
                    class319.field3030 = MusicPatchNode2.SpriteBuffer_getIndexedSpriteByName(class452.archive8,
                            "sl_button", "");
                }
            }
