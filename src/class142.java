public class class142 {
    ...
    public void method807(ClanSettings var1) {
        if (this.field1324 == var1.field1370 && this.field1322 == var1.field1354) {
            for (class139 var2 = (class139) this.field1323.last(); var2 != null; var2 = (class139) this.field1323
                    .previous()) {
                    ...
                    if (var0.targetIndex > 0) {
                        ...
                        if (var1 != null && var1.x >= 0 && var1.x < 13312 && var1.y >= 0 && var1.y < 13312) {
                            var0.setDestination(var1.x, var1.y,
                                    class147.getTileHeight(var1.x, var1.y, var0.plane) - var0.endHeight, Client.cycle);
                        }
                    }
                    ...
                    if (var0.targetIndex < 0) {
                        ...
                        if (var3 != null && var3.x >= 0 && var3.x < 13312 && var3.y >= 0 && var3.y < 13312) {
                            var0.setDestination(var3.x, var3.y,
                                    class147.getTileHeight(var3.x, var3.y, var0.plane) - var0.endHeight, Client.cycle);
                        }
                    }

                    var0.advance(Client.field432);
                    class31.scene.drawEntity(GameEngine.Client_plane, (int) var0.x, (int) var0.y, (int) var0.z, 60,
