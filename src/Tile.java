                        ...
                        if (var5 > 0) {
                            ...
                            if (Script.NetCache_currentResponse == null) {
                                ...
                                NetCache.NetCache_responseArchiveBuffer = new Buffer(
                                        var14 + var10 + Script.NetCache_currentResponse.padding);
                            ...
                            var6 = NetCache.NetCache_responseArchiveBuffer.array.length
                            ...
                            if (NetCache.field3506 != 0) {
                                for (var8 = 0; var8 < var7; ++var8) {
                                    NetCache.NetCache_responseArchiveBuffer.array[var8
                                            + NetCache.NetCache_responseArchiveBuffer.offset] ^= NetCache.field3506;
                                }
                            }
                            ...
                            if (var6 == NetCache.NetCache_responseArchiveBuffer.offset) {
                                if (Script.NetCache_currentResponse.key == 16711935L) {
                                    ...
                                    Script.NetCache_currentResponse.archive.write(
                                            (int) (Script.NetCache_currentResponse.key & 65535L),
                                            NetCache.NetCache_responseArchiveBuffer.array,
                                            16711680L == (Script.NetCache_currentResponse.key & 16711680L),
                                            NetCache.field3498);
                                }
