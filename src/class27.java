    ...
    static final void method122() {
        ...
        for (var1 = 0; var1 < class4.regionLandArchives.length; ++var1) {
            if (FontName.regionMapArchiveIds[var1] != -1 && class4.regionLandArchives[var1] == null) {
                class4.regionLandArchives[var1] = GrandExchangeOfferTotalQuantityComparator.archive9
                        .takeFile(FontName.regionMapArchiveIds[var1], 0);
            ...
            if (Archive.regionLandArchiveIds[var1] != -1 && ObjectSound.regionMapArchives[var1] == null) {
                ObjectSound.regionMapArchives[var1] = GrandExchangeOfferTotalQuantityComparator.archive9
                        .takeFileEncrypted(Archive.regionLandArchiveIds[var1], 0, GameObject.xteaKeys[var1]);
        ...
        if (!var0) {
            ...
            if (!var0) {
                ...
                if (Client.field489 != 0) {
                    WorldMapDecoration.drawLoadingMessage("Loading - please wait." + "<br>" + " (" + 100 + "%" + ")",
                            true);
                }
                ...
                if (!Client.isInInstance) {
                    ...
                    for (var15 = 0; var15 < var1; ++var15) {
                        ...
                        if (var5 != null) {
                            class323.playPcmPlayers();
                            WallDecoration.method1384(var5, var3, var4, class28.timeOfPreviousKeyPress * 8 - 48,
                                    class425.field3798 * 8 - 48, Client.collisionMaps);
                        }
                    }
                            ...
                            for (var4 = 0; var4 < 13; ++var4) {
                                ...
                                if (var6 != -1) {
                                    ...
                                    for (int var12 = 0; var12 < WorldMapAreaData.regions.length; ++var12) {
                                        if (WorldMapAreaData.regions[var12] == var11
                                                && class4.regionLandArchives[var12] != null) {
                                            int var13 = (var9 - var3) * 8;
                                            int var14 = (var10 - var4) * 8;
                                            class19.method78(class4.regionLandArchives[var12], var15, var3 * 8,
                            ...
                            for (var4 = 0; var4 < 13; ++var4) {
                                ...
                                if (var17 != -1) {
                                    ...
                                    for (var11 = 0; var11 < WorldMapAreaData.regions.length; ++var11) {
                                        if (WorldMapAreaData.regions[var11] == var10
                                                && ObjectSound.regionMapArchives[var11] != null) {
                                            Tiles.method473(ObjectSound.regionMapArchives[var11], var15, var3 * 8,
                                                    var4 * 8, var6, (var8 & 7) * 8, (var9 & 7) * 8, var7, class31.scene,
                                                    Client.collisionMaps);
                                            break;
                                        }
                                    }
                    ...
                    for (var7 = var3 - 1; var7 <= var4 + 1; ++var7) {
                        for (var8 = var17 - 1; var8 <= var6 + 1; ++var8) {
                            if (var7 < var3 || var7 > var4 || var8 < var17 || var8 > var6) {
                                GrandExchangeOfferTotalQuantityComparator.archive9
                                        .loadRegionFromName("m" + var7 + "_" + var8);
                                GrandExchangeOfferTotalQuantityComparator.archive9
                                        .loadRegionFromName("l" + var7 + "_" + var8);
                            }
                        }
                    }
                }
