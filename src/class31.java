        ...
        if (var0 == 1100) {
            ...
            if (var0 == 1113) {
                ...
                if (var4 != -1 && var3.type == 0) {
                    WallDecoration.revalidateWidgetScroll(VerticalAlignment.Widget_interfaceComponents[var4 >> 16],
                            var3, false);
                }
                ...
                var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                FillMode var12 = (FillMode) StructComposition.findEnumerated(GrandExchangeOffer.FillMode_values(),
                        var10);
                if (var12 != null) {
                    var3.fillMode = var12;
                    class144.invalidateWidget(var3);
                ...
                if (var0 == 1126) {
                    ...
                    var3.method1803(
                            ...
                            class14.urlRequester, Projectile.method450());
                    return 1;
                } else if (var0 == 1131) {
                    Interpreter.Interpreter_intStackSize -= 2;
                    var3.method1824(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
                            Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
                    return 1;
                } else if (var0 == 1132) {
                    var3.method1805(
                    ...
                    if (var0 == 1133) {
                        ...
                        var11 = var3.method1815();
                        if (var11 != null && var11
                                .method1711(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
                            class144.invalidateWidget(var3);
                        }
                        ...
                        var11 = var3.method1815();
                        if (var11 != null && var11
                                .method1784(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
                            class144.invalidateWidget(var3);
                        }
                        ...
                        var11 = var3.method1815();
                        if (var11 != null && var11
                                .method1712(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
                            class144.invalidateWidget(var3);
                        }
                        ...
                        if (var0 == 1140) {
                            ...
                            Interpreter.Interpreter_intStackSize -= 2;
                            var11 = var3.method1815();
                            if (var11 != null && var11.method1725(
                                    Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
                                    Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1])) {
                                class144.invalidateWidget(var3);
                            }
