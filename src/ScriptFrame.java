            ...
            if (var6 != var9) {
                ...
                if (var13 == 2 && class31.scene.getObjectFlags(GameEngine.Client_plane, var11, var12, var9) >= 0) {
                    ...
                    for (PendingSpawn var19 = (PendingSpawn) Client.pendingSpawns
                        ...
                        if (var19.plane == GameEngine.Client_plane && var11 == var19.x && var12 == var19.y
                                && var16 == var19.id) {
                            var18 = var19;
                            break;
                        }
                    ...
                    if (Client.isItemSelected == 1) {
                        MenuAction.insertMenuItemNoShift("Use",
                                Client.field364 + " " + "->" + " " + class383.colorStartTag(65535) + var17.name, 1,
                                var16, var11, var12);
                    } else if (Client.isSpellSelected) {
                        if ((SecureRandomFuture.selectedSpellFlags & 4) == 4) {
                            MenuAction.insertMenuItemNoShift(Client.field530,
                                    Client.field522 + " " + "->" + " " + class383.colorStartTag(65535) + var17.name, 2,
                                    var16, var11, var12);
                        }
                    } else {
                        ...
                        if (var32 != null) {
                            for (var20 = 4; var20 >= 0; --var20) {
                                if ((var18 == null || var18.method525(var20)) && var32[var20] != null) {
                                    ...
                                    MenuAction.insertMenuItemNoShift(var32[var20],
                                            class383.colorStartTag(65535) + var17.name, var21, var16, var11, var12);
                                }
                            }
                        }

                        MenuAction.insertMenuItemNoShift("Examine", class383.colorStartTag(65535) + var17.name, 1002,
                                var17.id, var11, var12);
                    }
                }
                ...
                if (var13 == 1) {
                    ...
                    if (var28.definition.size == 1 && (var28.x & 127) == 64 && (var28.y & 127) == 64) {
                        for (var23 = 0; var23 < Client.npcCount; ++var23) {
                            ...
                            if (var33 != null && var28 != var33 && var33.definition.size == 1 && var28.x == var33.x
                                    && var28.y == var33.y) {
                ...
                if (var13 == 0) {
                    ...
                    if ((var29.x & 127) == 64 && (var29.y & 127) == 64) {
                        for (var23 = 0; var23 < Client.npcCount; ++var23) {
                            var33 = Client.npcs[Client.npcIndices[var23]];
                            if (var33 != null && var33.definition.size == 1 && var29.x == var33.x
                                    && var33.y == var29.y) {
                                InvDefinition.addNpcToMenu(var33, Client.npcIndices[var23], var11, var12);
                            }
                        }
                ...
                if (var13 == 3) {
                    ...
                    if (var30 != null) {
                        for (TileItem var31 = (TileItem) var30.first(); var31 != null; var31 = (TileItem) var30
                                .next()) {
                            ItemComposition var35 = HealthBarUpdate.ItemDefinition_get(var31.id);
                            if (Client.isItemSelected == 1) {
                                MenuAction.insertMenuItemNoShift("Use", Client.field364 + " " + "->" + " "
                                        + class383.colorStartTag(16748608) + var35.name, 16, var31.id, var11, var12);
                            } else if (Client.isSpellSelected) {
                                if ((SecureRandomFuture.selectedSpellFlags & 1) == 1) {
                                    MenuAction.insertMenuItemNoShift(
                                            Client.field530, Client.field522 + " " + "->" + " "
                                                    + class383.colorStartTag(16748608) + var35.name,
                                            17, var31.id, var11, var12);
                                }
                            } else {
                                ...
                                for (int var36 = 4; var36 >= 0; --var36) {
                                    if (var31.method625(var36)) {
                                        if (var25 != null && var25[var36] != null) {
                                            ...
                                            MenuAction.insertMenuItemNoShift(var25[var36],
                                                    class383.colorStartTag(16748608) + var35.name, var22, var31.id,
                                                    var11, var12);
                                        } else if (var36 == 2) {
                                            MenuAction.insertMenuItemNoShift("Take",
                                                    class383.colorStartTag(16748608) + var35.name, 20, var31.id, var11,
                                                    var12);
                                        }
                                    }
                                }

                                MenuAction.insertMenuItemNoShift("Examine",
                                        class383.colorStartTag(16748608) + var35.name, 1004, var31.id, var11, var12);
                            }
                        }
                    }
                }
    ...
    static void method343(String var0) {
        ...
        try {
            ...
            if (var0.length() == 0) {
                ...
                var3 = var3 + "; Expires=" + class136.method789(class96.clockNow() + 94608000000L) + "; Max-Age="
                        + 94608000L;
            }
