...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
    ...
    protected final void setUp() {
        ...
        WorldMapID.masterDisk = new ArchiveDisk(255, JagexCache.JagexCache_dat2File, JagexCache.JagexCache_idx255File,
                500000);
    ...
    protected final void draw(boolean var1) {
            ...
            try {
                if (class297.musicPlayerStatus == 2) {
                    if (RouteStrategy.musicTrack == null) {
                        RouteStrategy.musicTrack = MusicTrack.readTrack(class297.musicTrackArchive,
                                class379.musicTrackGroupId, VarpDefinition.musicTrackFileId);
                        if (RouteStrategy.musicTrack == null) {
                            var2 = false;
                            break label175;
                        }
                    ...
                    if (class297.soundCache == null) {
                        class297.soundCache = new SoundCache(class297.soundEffectsArchive,
                                class297.musicSamplesArchive);
                    }

                    if (class475.midiPcmStream.loadMusicTrack(RouteStrategy.musicTrack, class297.musicPatchesArchive,
                            class297.soundCache, 22050)) {
        ...
        if ((gameState == 10 || gameState == 20 || gameState == 30) && field581 != 0L
                && class96.clockNow() > field581) {
        ...
        if (gameState == 0) {
            ...
            if (gameState == 20) {
                ...
                if (field489 == 1) {
                    ...
                    WorldMapDecoration.drawLoadingMessage("Loading - please wait." + "<br>" + " (" + var4 + "%" + ")",
                            false);
                } else if (field489 == 2) {
                ...
                WorldMapDecoration.drawLoadingMessage(
        ...
        if (gameState == 30 && gameDrawingMode == 0 && !var1 && !isResizable) {
            for (var4 = 0; var4 < rootWidgetCount; ++var4) {
                if (field574[var4]) {
                    RouteStrategy.rasterProvider.draw(rootWidgetXs[var4], rootWidgetYs[var4], rootWidgetWidths[var4],
    ...
    boolean method394() {
        return ModeWhere.field3571 != null && !ModeWhere.field3571.trim().isEmpty() && TileItem.field1079 != null
                && !TileItem.field1079.trim().isEmpty();
    }

    boolean method369() {
        return SpriteMask.field2808 != null && !SpriteMask.field2808.trim().isEmpty() && class121.field1185 != null
                && !class121.field1185.trim().isEmpty();
    }
            ...
            if (--js5Cycles + 1 <= 0) {
                try {
                    if (js5ConnectState == 0) {
                        WorldMapSection0.js5SocketTask = GameEngine.taskHandler.newSocketTask(UserComparator8.worldHost,
                                ItemContainer.currentPort);
                        ++js5ConnectState;
                    }
                    ...
                    if (js5ConnectState == 2) {
                        KitDefinition.js5Socket = class186.method1008((Socket) WorldMapSection0.js5SocketTask.result,
                                40000, 5000);
        ...
        try {
            ...
            if (loginState == 20) {
                if (this.field400 != null) {
                    ...
                    if (var25.method79() != 200) {
                        class387.RunException_sendStackTrace(
                                "Response code: " + var25.method79() + "Response body: " + var25.method81(),
                                (Throwable) null);
                        class315.getLoginError(65);
                        this.field390 = null;
                        return;
            ...
            if (loginState == 1) {
                if (class1.socketTask == null) {
                    class1.socketTask = GameEngine.taskHandler.newSocketTask(UserComparator8.worldHost,
                            ItemContainer.currentPort);
                }
            ...
            if (loginState == 5) {
                ...
                int[] var30 = new int[] { class174.secureRandom.nextInt(), class174.secureRandom.nextInt(),
                        class174.secureRandom.nextInt(), class174.secureRandom.nextInt() };
                var29.offset = 0;
                var29.writeByte(1);
            ...
            if (loginState == 13) {
                field391 = 0;
                class205.setLoginResponseString("You have only just left another world.",
                        "Your profile will be transferred in:", field393 / 60 + " seconds.");
                if (--field393 <= 0) {
                    class284.method1595(0);
                }
                ...
                if (loginState != 16) {
                    ...
                    if (var1.available() >= packetWriter.serverPacketLength) {
                        ...
                        for (InterfaceParent var37 = (InterfaceParent) interfaceParents
                                .first(); var37 != null; var37 = (InterfaceParent) interfaceParents.next()) {
            ...
            if (gameState == 30) {
                while (true) {
                    ...
                    if (!var30) {
                        ...
                        synchronized (UserComparator6.mouseRecorder.lock) {
                            if (!lockMouseRecorder) {
                                UserComparator6.mouseRecorder.index = 0;
                                    ...
                                    || UserComparator6.mouseRecorder.index >= 40) {
                                var31 = null;
                                var3 = 0;
                                var4 = 0;
                                var5 = 0;
                                ...
                                for (var7 = 0; var7 < UserComparator6.mouseRecorder.index
                                    ...
                                    if (var9 != lastMouseRecordX || var8 != lastMouseRecordY) {
                                        if (var31 == null) {
                                            var31 = class330.getPacketBufferNode(ClientPacket.field2559,
                                        ...
                                        if (-1L != lastMouseRecordTime) {
                                            ...
                                            var12 = (int) ((UserComparator6.mouseRecorder.millis[var7]
                                                    - lastMouseRecordTime) / 20L);
                                            var5 = (int) ((long) var5
                                                    + (UserComparator6.mouseRecorder.millis[var7] - lastMouseRecordTime)
                                                            % 20L);
                                        } else {
                                            var10 = var9;
                                            var11 = var8;
                                ...
                                if (var4 >= UserComparator6.mouseRecorder.index) {
                                    ...
                                    System.arraycopy(UserComparator6.mouseRecorder.xs, var4,
                                            UserComparator6.mouseRecorder.xs, 0, UserComparator6.mouseRecorder.index);
                                    System.arraycopy(UserComparator6.mouseRecorder.ys, var4,
                                            UserComparator6.mouseRecorder.ys, 0, UserComparator6.mouseRecorder.index);
                                    System.arraycopy(UserComparator6.mouseRecorder.millis, var4,
                                            UserComparator6.mouseRecorder.millis, 0,
                                            UserComparator6.mouseRecorder.index);
                                }
                            }
                        }
                        ...
                        for (PendingSpawn var38 = (PendingSpawn) pendingSpawns
                                .last(); var38 != null; var38 = (PendingSpawn) pendingSpawns.previous()) {
                            if (var38.endCycle > 0) {
                                --var38.endCycle;
                            }
                            ...
                            if (var38.endCycle == 0) {
                                if (var38.objectId < 0 || class195.method1053(var38.objectId, var38.field922)) {
                                    class81.addPendingSpawnToScene(var38.plane, var38.type, var38.x, var38.y,
                                            var38.objectId, var38.field927, var38.field922, var38.field931);
                                    var38.remove();
                                }
                            } else {
                                ...
                                if (var38.startCycle == 0 && var38.x >= 1 && var38.y >= 1 && var38.x <= 102
                                        && var38.y <= 102
                                        && (var38.id < 0 || class195.method1053(var38.id, var38.objectType))) {
                                    class81.addPendingSpawnToScene(var38.plane, var38.type, var38.x, var38.y, var38.id,
                                            var38.rotation, var38.objectType, var38.field931);
                                    var38.startCycle = -1;
                                    if (var38.objectId == var38.id && var38.objectId == -1) {
                                        var38.remove();
                                    } else if (var38.objectId == var38.id && var38.field927 == var38.rotation
                                            && var38.objectType == var38.field922) {
                                        var38.remove();
                                    }
                                }
                            }
                            ...
                            if (queuedSoundEffectDelays[var1] >= -10) {
                                ...
                                if (queuedSoundEffectDelays[var1] < 0) {
                                    if (soundLocations[var1] != 0) {
                                        ...
                                        var3 = (var4 - var9) * class20.clientPreferences.getAreaSoundEffectsVolume()
                                                / var4;
                                    } else {
                        ...
                        if (playingJingle && !class4.method8()) {
                            if (class20.clientPreferences.getCurrentMusicVolume() != 0 && currentTrackGroupId != -1) {
                                Message.method355(class399.archive6, currentTrackGroupId, 0,
                                        class20.clientPreferences.getCurrentMusicVolume(), false);
                            }
                        ...
                        while (keyHandlerInstance.method1154() && field355 < 128) {
                            if (staffModLevel >= 2 && keyHandlerInstance.getKeyPressed(82)
                                    && keyHandlerInstance.field1867 == 66) {
                                StringBuilder var44 = new StringBuilder();

                                Message var41;
                                for (Iterator var46 = Messages.Messages_hashTable.iterator(); var46.hasNext(); var44
                                        .append(var41.text).append('\n')) {
                        ...
                        if (rootInterface != -1) {
                            ReflectionCheck.updateRootInterface(rootInterface, 0, 0, GameEngine.canvasWidth,
                                    class262.canvasHeight, 0, 0);
                        }
                                                ...
                                                while (true) {
                                                    do {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (var48 == null) {
                                                                    ...
                                                                    if (Scene.shouldSendWalk()) {
                                                                        ...
                                                                        var18 = class330.getPacketBufferNode(
                                                                                ClientPacket.field2523,
                                                                                packetWriter.isaacCipher);
                                                                        var18.packetBuffer.writeByte(5);
                                                                        var18.packetBuffer
                                                                                .writeShortAdd(var5 + GameObject.baseY);
                                                                        var18.packetBuffer.writeIntME(
                                                                                var4 + WorldMapData_0.baseX);
                                                                        var18.packetBuffer.writeByteAdd(
                                                                    ...
                                                                    if (var40 != MidiPcmStream.mousedOverWidgetIf1) {
                                                                        ...
                                                                        if (MidiPcmStream.mousedOverWidgetIf1 != null) {
                                                                            class144.invalidateWidget(
                                                                                    MidiPcmStream.mousedOverWidgetIf1);
                                                                        }
                                                                    }

                                                                    if (var33 != class130.field1274
                                                                            && field515 == field514) {
                                                                        if (var33 != null) {
                                                                    ...
                                                                    if (oculusOrbState == 0) {
                                                                        ...
                                                                        if (class33.oculusOrbFocalPointX - var4 < -500
                                                                                || class33.oculusOrbFocalPointX
                                                                                        - var4 > 500
                                                                                || class144.oculusOrbFocalPointY
                                                                                        - var5 < -500
                                                                                || class144.oculusOrbFocalPointY
                                                                                        - var5 > 500) {
                                                                        ...
                                                                        var8 = class147.getTileHeight(
                                                                                class33.oculusOrbFocalPointX,
                                                                                class144.oculusOrbFocalPointY,
                                                                                GameEngine.Client_plane);
                                                                        var9 = 0;
                                                                        if (var6 > 3 && var7 > 3 && var6 < 100
                                                                                && var7 < 100) {
                                                                            for (var10 = var6 - 4; var10 <= var6
                                                                                    + 4; ++var10) {
                                                                                for (var11 = var7 - 4; var11 <= var7
                                                                                        + 4; ++var11) {
                                                                        ...
                                                                        class96.field1064 = class147.getTileHeight(
                                                                                MusicPatchNode.localPlayer.x,
                                                                                MusicPatchNode.localPlayer.y,
                                                                                GameEngine.Client_plane)
                                                                                - camFollowHeight;
                                                                        ...
                                                                        var6 = 0;
                                                                        if (var35 >= 0 || var36 != 0) {
                                                                            var6 = keyHandlerInstance.getKeyPressed(81)
                                                                                    ? oculusOrbSlowedSpeed * 583547559
                                                                                            * 519949591
                                                                                    : oculusOrbNormalSpeed * 1101365113
                                                                                            * -658916663;
                                                                            var6 *= 16;
                                                                            field595 = var35;
                                                                            field398 = var36;
                                                                        ...
                                                                        if (field644 > 0) {
                                                                            var7 = field644 / 16;
                                                                            if (field595 >= 0) {
                                                                                var4 = field595 - class125.cameraYaw
                                                                                        & 2047;
                                                                                var8 = Rasterizer3D.Rasterizer3D_sine[var4];
                                                                                var9 = Rasterizer3D.Rasterizer3D_cosine[var4];
                                                                                class33.oculusOrbFocalPointX += var7
                                                                                        * var8 / 65536;
                                                                                class144.oculusOrbFocalPointY += var9
                                                                                        * var7 / 65536;
                                                                            }
                                                                    ...
                                                                    if (MouseHandler.MouseHandler_currentButton == 4
                                                                        ...
                                                                        var4 = MouseHandler.MouseHandler_y
                                                                                - mouseCamClickedY;
                                                                        camAngleDX = var4 * 2;
                                                                        mouseCamClickedY = var4 != -1 && var4 != 1
                                                                                ? (mouseCamClickedY
                                                                                        + MouseHandler.MouseHandler_y)
                                                                                        / 2
                                                                                : MouseHandler.MouseHandler_y
                                                                                        * -360301979 * -1224153235;
                                                                        var5 = mouseCamClickedX
                                                                                - MouseHandler.MouseHandler_x;
                                                                        camAngleDY = var5 * 2;
                                                                        mouseCamClickedX = var5 != -1 && var5 != 1
                                                                                ? (mouseCamClickedX
                                                                                        + MouseHandler.MouseHandler_x)
                                                                                        / 2
                                                                                : MouseHandler.MouseHandler_x
                                                                                        * -264773825 * -2063363905;
                                                                    } else {
                                                                    ...
                                                                    if (field598) {
                                                                        ...
                                                                        if (!field541) {
                                                                            var4 = ObjTypeCustomisation.field1471 * 128
                                                                                    + 64;
                                                                            var5 = class123.field1209 * 128 + 64;
                                                                            var6 = class147.getTileHeight(var4, var5,
                                                                                    GameEngine.Client_plane)
                                                                                    - class16.field54;
                                                                            ...
                                                                            if (field615) {
                                                                                class174.cameraY = field535
                                                                                        .vmethod2320();
                                                                            } else {
                                                                                class174.cameraY = class147
                                                                                        .getTileHeight(class36.cameraX,
                                                                                                class297.cameraZ,
                                                                                                GameEngine.Client_plane)
                                                                                        - field535.vmethod2320();
                                                                            }
                                                                        ...
                                                                        if (!field614) {
                                                                            ...
                                                                            var6 = class147.getTileHeight(var4, var5,
                                                                                    GameEngine.Client_plane)
                                                                                    - ScriptFrame.field343;
                                                                            var7 = var4 - class36.cameraX;
                                                                            var8 = var6 - class174.cameraY;
                                                                            var9 = var5 - class297.cameraZ;
                                                                            var10 = (int) Math
                                                                                    .sqrt((double) (var7 * var7
                                                                                            + var9 * var9));
                                                                            var11 = (int) (Math.atan2((double) var8,
                                                                                    (double) var10)
                                                                                    * 325.9490051269531D) & 2047;
                                                                            var12 = (int) (Math.atan2((double) var7,
                                                                                    (double) var9)
                                                                                    * -325.9490051269531D) & 2047;
                                                                            GraphicsObject.method433(var11, var12);
                                                                        } else {
                                                                            if (field604 != null) {
                                                                                WorldMapSectionType.cameraPitch = field604
                                                                                        .method2318();
                                                                                WorldMapSectionType.cameraPitch = Math
                                                                                        .min(Math.max(
                                                                                                WorldMapSectionType.cameraPitch,
                                                                                                128), 383);
                                                                                field604.method2322();
                                                                            }

                                                                            if (field617 != null) {
                                                                                class125.cameraYaw = field617
                                                                                        .method2318() & 2047;
                                                                                field617.method2322();
                                                                            }
                                                                        }
                                                                    ...
                                                                    if (var4 > 15000 && var5 > 15000) {
                                                                        ...
                                                                        var26 = class330.getPacketBufferNode(
                                                        ...
                                                        var42 = class165.getWidget(var47.parentId);
                                                            ...
                                                            || var47.childIndex >= var42.children.length
                                                            || var47 != var42.children[var47.childIndex]);
    ...
    void resizeJS() {
        ...
        if (class20.clientPreferences != null) {
            try {
                class26.method113(ScriptFrame.client, "resize",
                        new Object[] { GrandExchangeOfferNameComparator.getWindowedMode() });
    ...
    final void drawLoggedIn() {
        ...
        if (!isMenuOpen) {
            ...
            FriendsChat.method2139(class192.menuX, ArchiveLoader.menuY, DesktopPlatformInfoProvider.menuWidth,
                    class147.menuHeight);
        }
        ...
        class324.method1839(GameEngine.Client_plane, MusicPatchNode.localPlayer.x, MusicPatchNode.localPlayer.y,
                field432);
        field432 = 0;
    }
        ...
        if (var2 == null) {
            ...
            try {
                ...
                if (ServerPacket.field2608 == var1.serverPacket) {
                    ...
                    PacketBufferNode var57 = class330.getPacketBufferNode(ClientPacket.OPLOC3,
                            packetWriter.isaacCipher);
                ...
                if (ServerPacket.field2649 == var1.serverPacket) {
                    ...
                    if (var20 != var54.rawX || flags != var54.rawY || var54.xAlignment != 0 || var54.yAlignment != 0) {
                        ...
                        if (var54.type == 0) {
                            WallDecoration.revalidateWidgetScroll(
                                    VerticalAlignment.Widget_interfaceComponents[graphic >> 16], var54, false);
                        }
                    }
                ...
                if (ServerPacket.field2690 == var1.serverPacket) {
                    ...
                    if (field615) {
                        ...
                        var30 = class147.getTileHeight(class36.cameraX, class297.cameraZ, GameEngine.Client_plane)
                                - class174.cameraY;
                        var10 = var20;
                    }

                    field535 = new class453(class36.cameraX, class297.cameraZ, var30, var26, var8, var10, graphic,
                            flags);
                    var1.serverPacket = null;
                    return true;
                }
                ...
                if (ServerPacket.field2628 == var1.serverPacket) {
                    ...
                    PlayerType var91 = (PlayerType) StructComposition.findEnumerated(StudioGame.PlayerType_values(),
                    ...
                    if (var95 == null) {
                        ...
                        while (true) {
                            if (var15 >= 100) {
                                if (var91.isUser
                                        && World.friendSystem.isIgnored(new Username(var31, class70.loginType))) {
                                    var61 = true;
                                }
                                break;
                            }
                    ...
                    if (!var61) {
                        ...
                        var16 = var66 >= 0 ? 41 : 44;
                        if (var91.modIcon != -1) {
                            class136.addChatMessage(var16, ArchiveDiskActionHandler.addImageTag(var91.modIcon) + var31,
                                    var40, var95.name);
                        } else {
                ...
                if (ServerPacket.field2609 == var1.serverPacket) {
                    ...
                    var30 = var83 + var26;
                    var10 = var60 + var8;
                    if (var26 >= 0 && var8 >= 0 && var26 < 104 && var8 < 104 && var30 >= 0 && var10 >= 0 && var30 < 104
                            && var10 < 104 && var96 != 65535) {
                        var26 = var26 * 128 + 64;
                        var8 = var8 * 128 + 64;
                        var30 = var30 * 128 + 64;
                        var10 = var10 * 128 + 64;
                        Projectile var19 = new Projectile(var96, GameEngine.Client_plane, var26, var8,
                                class147.getTileHeight(var26, var8, GameEngine.Client_plane) - var13, var15 + cycle,
                                var16 + cycle, var17, var18, var11, var65);
                        var19.setDestination(var30, var10,
                                class147.getTileHeight(var30, var10, GameEngine.Client_plane) - var65, var15 + cycle);
                ...
                if (ServerPacket.field2686 == var1.serverPacket) {
                    ...
                    for (var7 = (InterfaceParent) interfaceParents
                            .first(); var7 != null; var7 = (InterfaceParent) interfaceParents.next()) {
                        if (var7.field848) {
                            var7.field848 = false;
                        } else {
                ...
                if (ServerPacket.field2668 == var1.serverPacket) {
                    ...
                    if (var55 != null) {
                        ...
                        } else if (graphic == -1 || var55.sequence == -1
                                || ItemContainer.SequenceDefinition_get(graphic).forcedPriority >= ItemContainer
                                        .SequenceDefinition_get(var55.sequence).forcedPriority) {
                ...
                if (ServerPacket.field2631 == var1.serverPacket) {
                    ...
                    if (field615) {
                        ...
                        var11 = class147.getTileHeight(class36.cameraX, class297.cameraZ, GameEngine.Client_plane)
                                - class174.cameraY;
                        var96 = var20;
                    }

                    field535 = new class452(class36.cameraX, class297.cameraZ, var11, var30, var10, var96, graphic,
                            flags, var26, var8);
                    var1.serverPacket = null;
                    return true;
                }
                ...
                if (ServerPacket.field2614 == var1.serverPacket) {
                    ...
                    if (class138.field1314 >= 100) {
                        ...
                        class174.cameraY = class147.getTileHeight(class36.cameraX, class297.cameraZ,
                                GameEngine.Client_plane) - class16.field54;
                    }
                ...
                if (ServerPacket.field2657 == var1.serverPacket) {
                    ...
                    for (; var3.offset < var1.serverPacketLength; class373.itemContainerSetItem(graphic, var26,
                            var8 - 1, var30)) {
                ...
                if (ServerPacket.TRADING_POST_RESULTS == var1.serverPacket) {
                    ...
                    for (PendingSpawn var52 = (PendingSpawn) pendingSpawns
                            .last(); var52 != null; var52 = (PendingSpawn) pendingSpawns.previous()) {
                        if (var52.x >= class9.field28 && var52.x < class9.field28 + 8 && var52.y >= FontName.field3968
                                && var52.y < FontName.field3968 + 8 && var52.plane == GameEngine.Client_plane) {
                            var52.endCycle = 0;
                        }
                    }
                ...
                if (ServerPacket.field2679 == var1.serverPacket) {
                    ...
                    if (var28 != null) {
                        class144.invalidateWidget(var28);
                        WallDecoration.revalidateWidgetScroll(
                                VerticalAlignment.Widget_interfaceComponents[var28.id >>> 16], var28, true);
                    }
                ...
                if (ServerPacket.field2682 == var1.serverPacket) {
                    ...
                    if (WorldMapElement.field1503 >= 100) {
                        ...
                        WorldMapSectionType.cameraPitch = (int) (Math.atan2((double) var8, (double) var10)
                                * 325.9490051269531D) & 2047;
                        class125.cameraYaw = (int) (Math.atan2((double) var26, (double) var30) * -325.9490051269531D)
                                & 2047;
                    ...
                    if (var26 >= 0 && var8 >= 0 && var26 < 103 && var8 < 103) {
                        if (var96 == 0) {
                            ...
                            if (var94 != null) {
                                ...
                                if (var10 == 2) {
                                    var94.renderable1 = new DynamicObject(var15, 2, var11 + 4, GameEngine.Client_plane,
                                            var26, var8, var13, false, var94.renderable1);
                                    var94.renderable2 = new DynamicObject(var15, 2, var11 + 1 & 3,
                                            GameEngine.Client_plane, var26, var8, var13, false, var94.renderable2);
                                } else {
                                    var94.renderable1 = new DynamicObject(var15, var10, var11, GameEngine.Client_plane,
                                            var26, var8, var13, false, var94.renderable1);
                                }
                            }
                        } else if (var96 == 1) {
                            ...
                            if (var93 != null) {
                                ...
                                if (var10 != 4 && var10 != 5) {
                                    if (var10 == 6) {
                                        var93.renderable1 = new DynamicObject(var15, 4, var11 + 4,
                                                GameEngine.Client_plane, var26, var8, var13, false, var93.renderable1);
                                    } else if (var10 == 7) {
                                        var93.renderable1 = new DynamicObject(var15, 4, (var11 + 2 & 3) + 4,
                                                GameEngine.Client_plane, var26, var8, var13, false, var93.renderable1);
                                    } else if (var10 == 8) {
                                        var93.renderable1 = new DynamicObject(var15, 4, var11 + 4,
                                                GameEngine.Client_plane, var26, var8, var13, false, var93.renderable1);
                                        var93.renderable2 = new DynamicObject(var15, 4, (var11 + 2 & 3) + 4,
                                                GameEngine.Client_plane, var26, var8, var13, false, var93.renderable2);
                                    }
                                } else {
                                    var93.renderable1 = new DynamicObject(var15, 4, var11, GameEngine.Client_plane,
                                            var26, var8, var13, false, var93.renderable1);
                                }
                            }
                        } else if (var96 == 2) {
                            ...
                            if (var39 != null) {
                                var39.renderable = new DynamicObject(InterfaceParent.Entity_unpackID(var39.tag), var10,
                                        var11, GameEngine.Client_plane, var26, var8, var13, false, var39.renderable);
                            }
                        } else if (var96 == 3) {
                            FloorDecoration var92 = class31.scene.getFloorDecoration(GameEngine.Client_plane, var26,
                                    var8);
                            if (var92 != null) {
                                var92.renderable = new DynamicObject(InterfaceParent.Entity_unpackID(var92.tag), 22,
                                        var11, GameEngine.Client_plane, var26, var8, var13, false, var92.renderable);
                            }
                        }
                    }
                ...
                if (ServerPacket.UPDATE_RUNENERGY == var1.serverPacket) {
                    ...
                    var15 = class425.method2262(
                            (int) (Math.atan2((double) var30, (double) var11) * -325.9490051269531D) & 2047);
                ...
                if (ServerPacket.field2607 == var1.serverPacket) {
                    ...
                    var21 = (long) var3.readUnsignedShort();
                    var23 = (long) var3.readMedium();
                    PlayerType var44 = (PlayerType) StructComposition.findEnumerated(StudioGame.PlayerType_values(),
                            var3.readUnsignedByte());
                    ...
                    if (!var41 && field476 == 0) {
                        ...
                        field588 = (field588 + 1) % 100;
                        var25 = AbstractFont
                                .escapeBrackets(BuddyRankComparator.method711(SceneTilePaint.readString(var3)));
                        byte var63;
                        ...
                        if (var44.modIcon != -1) {
                            UserComparator5.addGameMessage(var63,
                                    ArchiveDiskActionHandler.addImageTag(var44.modIcon) + var49, var25);
                        } else {
                ...
                if (ServerPacket.field2597 == var1.serverPacket) {
                    ...
                    PlayerType var27 = (PlayerType) StructComposition.findEnumerated(StudioGame.PlayerType_values(),
                            var3.readUnsignedByte());
                    var42 = var9 + (var23 << 32);
                    boolean var14 = false;
                    ...
                    if (!var14 && field476 == 0) {
                        ...
                        var40 = AbstractFont
                                .escapeBrackets(BuddyRankComparator.method711(SceneTilePaint.readString(var3)));
                        if (var27.modIcon != -1) {
                            class136.addChatMessage(9, ArchiveDiskActionHandler.addImageTag(var27.modIcon) + var49,
                                    var40, FloorUnderlayDefinition.base37DecodeLong(var21));
                        } else {
                ...
                if (ServerPacket.field2685 == var1.serverPacket) {
                    ...
                    if (var26 >= 0 && var8 >= 0 && var26 < 104 && var8 < 104) {
                        var26 = var26 * 128 + 64;
                        var8 = var8 * 128 + 64;
                        GraphicsObject var12 = new GraphicsObject(var30, GameEngine.Client_plane, var26, var8,
                                class147.getTileHeight(var26, var8, GameEngine.Client_plane) - var10, var11, cycle);
                ...
                class387.RunException_sendStackTrace(
                        "" + (var1.serverPacket != null ? var1.serverPacket.id * 1287795301 * 1490038637 : -1) + ","
                                + (var1.field1139 != null ? var1.field1139.id * 1287795301 * 1490038637 : -1) + ","
                                + (var1.field1133 != null ? var1.field1133.id * 1287795301 * 1490038637 : -1) + ","
                ...
                var31 = "" + (var1.serverPacket != null ? var1.serverPacket.id * 1287795301 * 1490038637 : -1) + ","
                        + (var1.field1139 != null ? var1.field1139.id * 1287795301 * 1490038637 : -1) + ","
                        + (var1.field1133 != null ? var1.field1133.id * 1287795301 * 1490038637 : -1) + ","
                        + var1.serverPacketLength + "," + (MusicPatchNode.localPlayer.pathX[0] + WorldMapData_0.baseX)
                        + "," + (MusicPatchNode.localPlayer.pathY[0] + GameObject.baseY) + ",";
        ...
        if (clickedWidget == null) {
            ...
            if (isMenuOpen) {
                ...
                if (var1 != 1 && (class473.mouseCam || var1 != 4)) {
                    ...
                    if (var2 < class192.menuX - 10 || var2 > DesktopPlatformInfoProvider.menuWidth + class192.menuX + 10
                            || var3 < ArchiveLoader.menuY - 10
                            || var3 > ArchiveLoader.menuY + class147.menuHeight + 10) {
                        isMenuOpen = false;
                        var4 = class192.menuX;
                        ...
                        for (var8 = 0; var8 < rootWidgetCount; ++var8) {
                            if (rootWidgetWidths[var8] + rootWidgetXs[var8] > var4 && rootWidgetXs[var8] < var4 + var6
                                    && rootWidgetHeights[var8] + rootWidgetYs[var8] > var5
                                    && rootWidgetYs[var8] < var7 + var5) {
                                field573[var8] = true;
                            }
                        }
                    }
                ...
                if (var1 == 1 || !class473.mouseCam && var1 == 4) {
                    ...
                    if (var7 != -1 && var7 >= 0) {
                        ...
                        class17.menuAction(var8, var9, var10, var11, var12, var13, var14,
                    ...
                    for (var12 = 0; var12 < rootWidgetCount; ++var12) {
                        if (rootWidgetWidths[var12] + rootWidgetXs[var12] > var8 && rootWidgetXs[var12] < var10 + var8
                                && rootWidgetYs[var12] + rootWidgetHeights[var12] > var9
                                && rootWidgetYs[var12] < var9 + var11) {
                            field573[var12] = true;
                        }
                    }
                }
                ...
                if ((var1 == 1 || !class473.mouseCam && var1 == 4) && menuOptionsCount > 0 && var2 >= 0) {
                    ...
                    class17.menuAction(var3, var4, var5, var6, var7, var15, var16,
                            MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY);
                }
    ...
    final void method389() {
        ...
        if (field622 && field540) {
            ...
            if (class96.widgetDragDuration > clickedWidget.dragThreshold
            ...
            if (MouseHandler.MouseHandler_currentButton == 0) {
                if (isDraggingWidget) {
                    ...
                    if (draggedOnWidget != null) {
                        ...
                        if (var13 != null) {
                            PacketBufferNode var12 = class330.getPacketBufferNode(ClientPacket.field2515,
                                    packetWriter.isaacCipher);
    ...
    public final void init() {
        if (this.checkHost()) {
            ...
            for (int var1 = 0; var1 <= 28; ++var1) {
                ...
                if (var2 != null) {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        field358 = (StudioGame) StructComposition.findEnumerated(TaskHandler.method951(),
            ...
            try {
                ...
                class130.cacheParentPaths = new String[] { "c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/",
                        "c:/", HorizontalAlignment.userHomeDirectory, "/tmp/", "" };
                class96.cacheSubPaths = new String[] { ".jagex_cache_" + JagexCache.cacheGamebuild,
                        ".file_store_" + JagexCache.cacheGamebuild };

                label153: for (var3 = 0; var3 < 4; ++var3) {
                ...
                JagexCache.JagexCache_dat2File = new BufferedFile(
                        new AccessFile(class138.getFile("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
                JagexCache.JagexCache_idx255File = new BufferedFile(
                        new AccessFile(class138.getFile("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
                class370.JagexCache_idxFiles = new BufferedFile[JagexCache.idxCount];

                for (int var14 = 0; var14 < JagexCache.idxCount; ++var14) {
                    class370.JagexCache_idxFiles[var14] = new BufferedFile(
                            new AccessFile(class138.getFile("main_file_cache.idx" + var14), "rw", 1048576L), 6000, 0);
                }
            } catch (Exception var19) {
                class387.RunException_sendStackTrace((String) null, var19);
            }
