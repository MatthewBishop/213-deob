    ...
    static void runScript(ScriptEvent var0, int var1, int var2) {
        ...
        if (var4 != null) {
            ...
            label953: {
                label954: {
                    try {
                        ...
                        try {
                            ...
                            for (var13 = 1; var13 < var3.length; ++var13) {
                                if (var3[var13] instanceof Integer) {
                                    ...
                                    if (var14 == -2147483643) {
                                        var14 = var0.widget != null ? var0.widget.childIndex * -1274125071 * 55577617
                                                : -1;
                                    }

                                    if (var14 == -2147483642) {
                                        var14 = var0.dragTarget != null ? var0.dragTarget.id * 1713081171 * 346484955
                                                : -1;
                                    }

                                    if (var14 == -2147483641) {
                                        var14 = var0.dragTarget != null
                                                ? var0.dragTarget.childIndex * -1274125071 * 55577617
                                                : -1;
                                    }
                            ...
                            label937: while (true) {
                                ...
                                if (var33 >= 100) {
                                    ...
                                    var13 = var7[var20];
                                    Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                            - 1] = class252.getVarbit(var13);
                                } else if (var33 == 27) {
                                    var13 = var7[var20];
                                    class283.method1593(var13,
                                            Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                                } else if (var33 == 31) {
                                    Interpreter.Interpreter_intStackSize -= 2;
                                    if (Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
                                    ...
                                    var21 = WorldMapSprite.method1524(Interpreter.Interpreter_stringStack,
                                            SecureRandomCallable.Interpreter_stringStackSize, var13);
                                    Interpreter.Interpreter_stringStack[++SecureRandomCallable.Interpreter_stringStackSize
                                            - 1] = var21;
                                } else if (var33 == 38) {
                                    ...
                                    if (var33 != 40) {
                                        if (var33 == 42) {
                                            Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
                                                    - 1] = class373.varcs.getInt(var7[var20]);
                                        } else if (var33 == 43) {
                                            class373.varcs.setInt(var7[var20],
                                                    Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                                        } else if (var33 == 44) {
                                            var13 = var7[var20] >> 16;
                                            var14 = var7[var20] & '\uffff';
                                            ...
                                            if (var33 == 47) {
                                                ...
                                                class373.varcs.setStringOld(var7[var20],
                                                        Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize]);
                                            } else if (var33 == 49) {
                                                ...
                                                class373.varcs.setString(var7[var20],
                                                        Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize]);
                                            } else if (var33 == 60) {
                        ...
                        if (var30) {
                            while (Interpreter.field690.size() > 0) {
                                ...
                                Message.widgetDefaultMenuAction(var19.method615(), var19.method613(), var19.method614(),
                                        var19.method616(), "");
                            }
                            ...
                            if (!var9 && var2 > 0 && var10 >= var2) {
                                class387.RunException_sendStackTrace("Warning: Script " + var4.field794
                    ...
                    while (Interpreter.field690.size() > 0) {
                        ...
                        Message.widgetDefaultMenuAction(var34.method615(), var34.method613(), var34.method614(),
                                var34.method616(), "");
                    }
                ...
                while (Interpreter.field690.size() > 0) {
                    ...
                    Message.widgetDefaultMenuAction(var41.method615(), var41.method613(), var41.method614(),
                            var41.method616(), "");
                }
                ...
                if (!var9 && var2 > 0 && var10 >= var2) {
                    class387.RunException_sendStackTrace(
                            "Warning: Script " + var4.field794 + " finished at op count " + var10 + " of max " + var1,
                            (Throwable) null);
                }
            ...
            while (Interpreter.field690.size() > 0) {
                ...
                Message.widgetDefaultMenuAction(var26.method615(), var26.method613(), var26.method614(),
                        var26.method616(), "");
            }
