public class DevicePcmPlayerProvider implements class50 {
    ...
    static void method89(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8,
            int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18,
            int var19, int var20, int var21) {
        Rasterizer3D.field1999.vmethod1378(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11,
    ...
    static void load() {
        ...
        if (Client.titleLoadingStage == 0) {
            ...
            GrandExchangeOfferTotalQuantityComparator.archive9 = WorldMapLabelSize.newArchive(5, true, true, true,
                    false);
            ...
            GrandExchangeOfferUnitPriceComparator.archive18 = WorldMapLabelSize.newArchive(18, false, true, true,
                    false);
            ...
            if (Client.titleLoadingStage == 45) {
                ...
                if (Client.titleLoadingStage == 60) {
                    ...
                    if (!class85.archive2.isFullyLoaded()) {
                        ...
                        class4.method10(class85.archive4, FloorUnderlayDefinition.archive11, class452.archive8,
                                class128.archive13);
                        ...
                        class160.HitSplatDefinition_cachedSprites = new class473(Client.field358, 54,
                                ClanSettings.clientLanguage, class85.archive2);
                        MenuAction.HitSplatDefinition_cached = new class473(Client.field358, 47,
                                ClanSettings.clientLanguage, class85.archive2);
                    ...
                    if (ChatChannel.compass == null) {
                        ChatChannel.compass = class484.SpriteBuffer_getSprite(class452.archive8,
                                Varcs.spriteIds.compass, 0);
                    } else {
                        ++var18;
                    }

                    if (LoginScreenAnimation.redHintArrowSprite == null) {
                        LoginScreenAnimation.redHintArrowSprite = class484.SpriteBuffer_getSprite(class452.archive8,
                                Varcs.spriteIds.field3767, 0);
                    } else {
                        ++var18;
                    }
                    ...
                    if (class36.headIconPkSprites == null) {
                        class36.headIconPkSprites = UserComparator3.method699(class452.archive8,
                                Varcs.spriteIds.headIconsPk, 0);
                    } else {
                        ++var18;
                    }

                    if (class425.headIconPrayerSprites == null) {
                        class425.headIconPrayerSprites = UserComparator3.method699(class452.archive8,
                                Varcs.spriteIds.field3775, 0);
                    } else {
                        ++var18;
                    }

                    if (KitDefinition.headIconHintSprites == null) {
                        KitDefinition.headIconHintSprites = UserComparator3.method699(class452.archive8,
                                Varcs.spriteIds.field3772, 0);
                    } else {
                        ++var18;
                    }

                    if (Players.mapMarkerSprites == null) {
                        Players.mapMarkerSprites = UserComparator3.method699(class452.archive8,
                                Varcs.spriteIds.field3773, 0);
                    } else {
                        ++var18;
                    }

                    if (class173.crossSprites == null) {
                        class173.crossSprites = UserComparator3.method699(class452.archive8, Varcs.spriteIds.field3771,
                                0);
                    } else {
                        ++var18;
                    }
                    ...
                    if (class477.mapDotSprites == null) {
                        class477.mapDotSprites = UserComparator3.method699(class452.archive8, Varcs.spriteIds.field3774,
                                0);
                    } else {
                        ++var18;
                    }
                    ...
                    if (!WorldMapLabelSize.field2285.isFullyLoaded()) {
                        ...
                        class7.textureProvider = new TextureProvider(WorldMapLabelSize.field2285, class452.archive8, 20,
                                class20.clientPreferences.getBrightness(), Client.isLowDetail ? 64 : 128);
                    ...
                    if (class28.archive19.getGroupCount() > 0
                            && !class28.archive19.tryLoadGroupByName(WorldMapCacheName.field2435.name)) {
                        Login.Login_loadingText = "Loading world map - "
                                + class28.archive19.groupLoadPercentByName(WorldMapCacheName.field2435.name) / 10 + "%";
                    } else {
                        if (class126.worldMap == null) {
                            class126.worldMap = new WorldMap();
                            class126.worldMap.init(class28.archive19, GrandExchangeOfferUnitPriceComparator.archive18,
                                    class205.archive20, class137.fontBold12, Client.fontsMap, class333.mapSceneSprites);
                        }
