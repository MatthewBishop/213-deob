public class class146 extends class139 {
    ...
    static final void updateNpcs(boolean var0, PacketBuffer var1) {
        ...
        for (var2 = 0; var2 < Client.field416; ++var2) {
            ...
            if ((var5 & 64) != 0) {
                ...
                if (var6 == var4.sequence && var6 != -1) {
                    ...
                    if (var8 == 2) {
                        ...
                        || ItemContainer.SequenceDefinition_get(var6).forcedPriority >= ItemContainer
                                .SequenceDefinition_get(var4.sequence).forcedPriority) {
                    var4.sequence = var6;
                    var4.sequenceFrame = 0;
                    var4.sequenceFrameCycle = 0;
                    var4.sequenceDelay = var7;
            ...
            if ((var5 & 262144) != 0) {
                var6 = var1.readInt();
                var4.turnLeftSequence = (var6 & 1) != 0 ? var1.readUnsignedShort()
                        : var4.definition.turnLeftSequence * 1526449071 * -2117504177;
                var4.turnRightSequence = (var6 & 2) != 0 ? var1.readUnsignedShort()
                        : var4.definition.turnRightSequence * 1635935495 * 1325267127;
                var4.walkSequence = (var6 & 4) != 0 ? var1.readUnsignedShortLE()
                        : var4.definition.walkSequence * 849832979 * 1653161499;
                var4.walkBackSequence = (var6 & 8) != 0 ? var1.readUnsignedShort()
                        : var4.definition.walkBackSequence * -820247353 * 606174455;
                var4.walkLeftSequence = (var6 & 16) != 0 ? var1.readUnsignedShort()
                        : var4.definition.walkLeftSequence * 1030172671 * 429445119;
                var4.walkRightSequence = (var6 & 32) != 0 ? var1.readUnsignedShort()
                        : var4.definition.walkRightSequence * -1237616413 * -2142663477;
                var4.runSequence = (var6 & 64) != 0 ? var1.readUnsignedShort()
                        : var4.definition.runSequence * -1565402875 * 1104808909;
                var4.runBackSequence = (var6 & 128) != 0 ? var1.readUnsignedShortAddLE()
                        : var4.definition.runBackSequence * -1535672631 * 1434909561;
                var4.runLeftSequence = (var6 & 256) != 0 ? var1.readUnsignedShortAddLE()
                        : var4.definition.runLeftSequence * -1171795391 * -257868351;
                var4.runRightSequence = (var6 & 512) != 0 ? var1.readUnsignedShortAddLE()
                        : var4.definition.runRightSequence * 1924156607 * -1734270145;
                var4.crawlSequence = (var6 & 1024) != 0 ? var1.readUnsignedShort()
                        : var4.definition.crawlSequence * -237251001 * -1186532489;
                var4.crawlBackSequence = (var6 & 2048) != 0 ? var1.readUnsignedShort()
                        : var4.definition.crawlBackSequence * 1456216629 * -1296177123;
                var4.crawlLeftSequence = (var6 & 4096) != 0 ? var1.readUnsignedShortAdd()
                        : var4.definition.crawlLeftSequence * -750567499 * -2136803683;
                var4.crawlRightSequence = (var6 & 8192) != 0 ? var1.readUnsignedShortLE()
                        : var4.definition.crawlRightSequence * 2044090389 * 1520351037;
                var4.idleSequence = (var6 & 16384) != 0 ? var1.readUnsignedShortAdd()
                        : var4.definition.idleSequence * 1304162881 * 1235033537;
            }
