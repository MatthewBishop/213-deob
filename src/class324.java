public enum class324 implements class356 {
    ...
    static void method1839(int var0, int var1, int var2, int var3) {
        for (ObjectSound var4 = (ObjectSound) ObjectSound.objectSounds
            ...
            if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
                ...
                if (var5 - 64 <= var4.field673 && class20.clientPreferences.getAreaSoundEffectsVolume() != 0
                        && var0 == var4.plane) {
                    var5 -= 64;
                    if (var5 < 0) {
                        var5 = 0;
                    ...
                    int var6 = (var4.field673 - var5) * class20.clientPreferences.getAreaSoundEffectsVolume()
                            / var4.field673;
                    ...
                    if (var4.stream2 == null) {
                        if (var4.soundEffectIds != null && (var4.field679 -= var3) <= 0) {
                            ...
                            SoundEffect var12 = SoundEffect.readSoundEffect(class426.field3811,
                            ...
                            if (var12 != null) {
                                ...
                                var4.stream2 = var10;
                                var4.field679 = var4.field681
                                        + (int) (Math.random() * (double) (var4.field682 - var4.field681));
                            }
                        }
                    } else {
    ...
    static void method1838() {
        if (Client.oculusOrbOnLocalPlayer && MusicPatchNode.localPlayer != null) {
            ...
            int var2 = class147.getTileHeight(MusicPatchNode.localPlayer.x, MusicPatchNode.localPlayer.y,
                    GameEngine.Client_plane) - Client.camFollowHeight;
